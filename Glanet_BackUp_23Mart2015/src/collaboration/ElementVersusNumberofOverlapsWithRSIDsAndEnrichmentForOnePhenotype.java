...
public class ElementVersusNumberofOverlapsWithRSIDsAndEnrichmentForOnePhenotype {
	...
	public static void readRSIDMap(String inputFileName, Map<String, String> overlap2RSIDMap) {
		...
		try {
			...
			while ((strLine = bufferedReader.readLine()) != null) {
				// SNPid mesh_term Expressed.gene.associated.with.the.SNP Type
				// SNP_Fx_Allele SNP_Non_Fx_Allele SNP_Fx_Allele_Freq SNP_MAF
				// SNP_Imputation_RSq SNP_Chr.x SNP_Pos_hg19.x Transcript_Chr
				// Transcript_Start_hg19 RSq log10P
				// IsValidated.in.Blood.eQTL.Broswer
				// rs10821415 Atrial Fibrillation C9orf3 cis C A 0.57359 0.42641
				// 0.96657 9 97713459 9 97488991 0.008 -10.45 No
	...
	public static void readAnnotationResults(String outputFolder, List<ElementAnnotationEnrichment> dnaseElements, List<ElementAnnotationEnrichment> tfElements, List<ElementAnnotationEnrichment> histoneElements, List<ElementAnnotationEnrichment> exonBasedKEGGPathwayElements, List<ElementAnnotationEnrichment> regulationBasedKEGGPathwayElements, List<ElementAnnotationEnrichment> allBasedKEGGPathwayElements, List<ElementAnnotationEnrichment> tfExonBasedKEGGPathwayElements, List<ElementAnnotationEnrichment> tfRegulationBasedKEGGPathwayElements, List<ElementAnnotationEnrichment> tfAllBasedKEGGPathwayElements, List<ElementAnnotationEnrichment> tfCellLineExonBasedKEGGPathwayElements, List<ElementAnnotationEnrichment> tfCellLineRegulationBasedKEGGPathwayElements, List<ElementAnnotationEnrichment> tfCellLineAllBasedKEGGPathwayElements) {

		/****************************************************************************/
		/********************************** DNASE starts ******************************/
		/****************************************************************************/
		// Get the annotations per elementName which are under
		// .../GLANET/Output/jobName/Annotation
	...
	public static void readEnrichmentResults(String outputFolder, float bonferroniCorrectionSignificanceLevel, Map<String, ElementEnrichment> dnaseMap, Map<String, ElementEnrichment> tfMap, Map<String, ElementEnrichment> histoneMap, Map<String, ElementEnrichment> exonBasedKEGGPathwayMap, Map<String, ElementEnrichment> regulationBasedKEGGPathwayMap, Map<String, ElementEnrichment> allBasedKEGGPathwayMap, Map<String, ElementEnrichment> tfExonBasedKEGGPathwayMap, Map<String, ElementEnrichment> tfRegulationBasedKEGGPathwayMap, Map<String, ElementEnrichment> tfAllBasedKEGGPathwayMap, Map<String, ElementEnrichment> tfCellLineExonBasedKEGGPathwayMap, Map<String, ElementEnrichment> tfCellLineRegulationBasedKEGGPathwayMap, Map<String, ElementEnrichment> tfCellLineAllBasedKEGGPathwayMap) {

		/****************************************************************************/
		/********************************** DNASE starts ******************************/
		/****************************************************************************/
		// Get the enrichment results per elementName which are under
		// .../GLANET/Output/jobName/Enrichment
	...
	public static void augmentAnnotationandEnrichmentResultsWithRSIds(Map<String, String> overlap2RSIDMap, List<ElementAnnotationEnrichment> elementListFromAnnotation, Map<String, ElementEnrichment> elementMapFromEnrichment) {
	...
	public static void augmentAnnotationResultsWithRsIds(String annotationResultsInputFileName, String annotationResultsWithRsIdsOutputFileName, Map<String, String> overlap2RSIDMap, Map<String, String> overlap2EQTLMap) {
		...
		try {
			...
			BufferedReader bufferedReader = new BufferedReader(FileOperations.createFileReader(annotationResultsInputFileName));
			BufferedWriter bufferedWriter = new BufferedWriter(FileOperations.createFileWriter(annotationResultsWithRsIdsOutputFileName));
			...
			// example strLine
			// chr1 11862777 11862777 chr1 11820828 11910827 NM_001040194
			// THREE_D AGTRAP 57085
	...
	public static void augmentAnnotationandEnrichmentResultsWithRSIds(Map<String, String> overlap2RSIDMap, List<ElementAnnotationEnrichment> dnaseElements, List<ElementAnnotationEnrichment> tfElements, List<ElementAnnotationEnrichment> histoneElements, List<ElementAnnotationEnrichment> exonBasedKEGGPathwayElements, List<ElementAnnotationEnrichment> regulationBasedKEGGPathwayElements, List<ElementAnnotationEnrichment> allBasedKEGGPathwayElements, List<ElementAnnotationEnrichment> tfExonBasedKEGGPathwayElements, List<ElementAnnotationEnrichment> tfRegulationBasedKEGGPathwayElements, List<ElementAnnotationEnrichment> tfAllBasedKEGGPathwayElements, List<ElementAnnotationEnrichment> tfCellLineExonBasedKEGGPathwayElements, List<ElementAnnotationEnrichment> tfCellLineRegulationBasedKEGGPathwayElements, List<ElementAnnotationEnrichment> tfCellLineAllBasedKEGGPathwayElements, Map<String, ElementEnrichment> dnaseMap, Map<String, ElementEnrichment> tfMap, Map<String, ElementEnrichment> histoneMap, Map<String, ElementEnrichment> exonBasedKEGGPathwayMap, Map<String, ElementEnrichment> regulationBasedKEGGPathwayMap, Map<String, ElementEnrichment> allBasedKEGGPathwayMap, Map<String, ElementEnrichment> tfExonBasedKEGGPathwayMap, Map<String, ElementEnrichment> tfRegulationBasedKEGGPathwayMap, Map<String, ElementEnrichment> tfAllBasedKEGGPathwayMap, Map<String, ElementEnrichment> tfCellLineExonBasedKEGGPathwayMap, Map<String, ElementEnrichment> tfCellLineRegulationBasedKEGGPathwayMap, Map<String, ElementEnrichment> tfCellLineAllBasedKEGGPathwayMap) {
	...
	public static void writeAnnotationEnrichmentWithRSIDsSummaryTable(String encodeCollaborationDirectory, String extraDirectoryName, String initialFileName, MultipleTestingType multipleTestingParameter, List<ElementAnnotationEnrichment> augmentedElementList) {
		...
		// sort the elements w.r.t. its pValue from smallest to largest before
		// traversing the list
	...
	public static void writeAnnotationEnrichmentWithRSIDsSummaryTable(String outputFolder, MultipleTestingType multipleTestingParameter, List<ElementAnnotationEnrichment> dnaseElements, List<ElementAnnotationEnrichment> tfElements, List<ElementAnnotationEnrichment> histoneElements, List<ElementAnnotationEnrichment> exonBasedKEGGPathwayElements, List<ElementAnnotationEnrichment> regulationBasedKEGGPathwayElements, List<ElementAnnotationEnrichment> allBasedKEGGPathwayElements, List<ElementAnnotationEnrichment> tfExonBasedKEGGPathwayElements, List<ElementAnnotationEnrichment> tfRegulationBasedKEGGPathwayElements, List<ElementAnnotationEnrichment> tfAllBasedKEGGPathwayElements, List<ElementAnnotationEnrichment> tfCellLineExonBasedKEGGPathwayElements, List<ElementAnnotationEnrichment> tfCellLineRegulationBasedKEGGPathwayElements, List<ElementAnnotationEnrichment> tfCellLineAllBasedKEGGPathwayElements) {
