...
public class Log4jConfiguration {
	...
	public static void getGlanetApplicationLogger(String dataFolder, String outputFolder) throws IOException {
		...
		try {
			...
			// //for debug
			// System.out.println("glanetLogFileUnderOutputFolder: " +
			// logProp.getProperty("log4j.appender.file.File"));
			// //for debug

			System.out.println("Logging enabled");

			// This calls activateOptions of NewLogForEachGlanetRunFileAppender
			// class
