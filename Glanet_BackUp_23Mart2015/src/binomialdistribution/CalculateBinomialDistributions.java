...
public class CalculateBinomialDistributions {
	 ...
	 * annotate.intervals.parametric.AnnotateGivenIntervalsWithGivenParameters
	 * has to be run with the same input file used in the binomial distribution
	 * calculations.
	 */
	...
	public static void main(String[] args) {
		...
		// searchInputDataSize =
		// calculate.calculateSearchInputSize(Commons.TCGA_INPUT_DATA_WITH_NON_BLANKS_SNP_IDS_WITHOUT_OVERLAPS);
		// searchInputDataSize =
		// calculate.calculateSearchInputSize(Commons.OCD_GWAS_SIGNIFICANT_SNPS_WITHOUT_OVERLAPS);
		// searchInputDataSize =
		// calculate.calculateSearchInputSize(Commons.POSITIVE_CONTROL_OUTPUT_FILE_NAME_WITHOUT_OVERLAPS);
