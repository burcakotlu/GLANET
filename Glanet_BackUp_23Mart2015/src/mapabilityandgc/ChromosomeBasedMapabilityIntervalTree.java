...
public class ChromosomeBasedMapabilityIntervalTree {
	...
	public static IntervalTree getChromosomeBasedMapabilityIntervalTree(ChromosomeName chromName, int chromSize) {
		switch (chromName) {
			case CHROMOSOME1:
				return getChromosome1MapabilityIntervalTree(chromSize);
			case CHROMOSOME2:
				return getChromosome2MapabilityIntervalTree(chromSize);
			case CHROMOSOME3:
				return getChromosome3MapabilityIntervalTree(chromSize);
			case CHROMOSOME4:
				return getChromosome4MapabilityIntervalTree(chromSize);
			case CHROMOSOME5:
				return getChromosome5MapabilityIntervalTree(chromSize);
			case CHROMOSOME6:
				return getChromosome6MapabilityIntervalTree(chromSize);
			case CHROMOSOME7:
				return getChromosome7MapabilityIntervalTree(chromSize);
			case CHROMOSOME8:
				return getChromosome8MapabilityIntervalTree(chromSize);
			case CHROMOSOME9:
				return getChromosome9MapabilityIntervalTree(chromSize);
			case CHROMOSOME10:
				return getChromosome10MapabilityIntervalTree(chromSize);
			case CHROMOSOME11:
				return getChromosome11MapabilityIntervalTree(chromSize);
			case CHROMOSOME12:
				return getChromosome12MapabilityIntervalTree(chromSize);
			case CHROMOSOME13:
				return getChromosome13MapabilityIntervalTree(chromSize);
			case CHROMOSOME14:
				return getChromosome14MapabilityIntervalTree(chromSize);
			case CHROMOSOME15:
				return getChromosome15MapabilityIntervalTree(chromSize);
			case CHROMOSOME16:
				return getChromosome16MapabilityIntervalTree(chromSize);
			case CHROMOSOME17:
				return getChromosome17MapabilityIntervalTree(chromSize);
			case CHROMOSOME18:
				return getChromosome18MapabilityIntervalTree(chromSize);
			case CHROMOSOME19:
				return getChromosome19MapabilityIntervalTree(chromSize);
			case CHROMOSOME20:
				return getChromosome20MapabilityIntervalTree(chromSize);
			case CHROMOSOME21:
				return getChromosome21MapabilityIntervalTree(chromSize);
			case CHROMOSOME22:
				return getChromosome22MapabilityIntervalTree(chromSize);
			case CHROMOSOMEX:
				return getChromosomeXMapabilityIntervalTree(chromSize);
			case CHROMOSOMEY:
				return getChromosomeYMapabilityIntervalTree(chromSize);
