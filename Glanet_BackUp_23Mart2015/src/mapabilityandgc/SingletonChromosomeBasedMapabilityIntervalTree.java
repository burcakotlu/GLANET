...
public class SingletonChromosomeBasedMapabilityIntervalTree {
	...
	public static IntervalTree getSingletonChromosomeBasedMapabilityIntervalTree(ChromosomeName chromName, int chromSize) {
		switch (chromName) {
			case CHROMOSOME1:
				return getSingletonChromosome1MapabilityIntervalTree(chromSize);
			case CHROMOSOME2:
				return getSingletonChromosome2MapabilityIntervalTree(chromSize);
			case CHROMOSOME3:
				return getSingletonChromosome3MapabilityIntervalTree(chromSize);
			case CHROMOSOME4:
				return getSingletonChromosome4MapabilityIntervalTree(chromSize);
			case CHROMOSOME5:
				return getSingletonChromosome5MapabilityIntervalTree(chromSize);
			case CHROMOSOME6:
				return getSingletonChromosome6MapabilityIntervalTree(chromSize);
			case CHROMOSOME7:
				return getSingletonChromosome7MapabilityIntervalTree(chromSize);
			case CHROMOSOME8:
				return getSingletonChromosome8MapabilityIntervalTree(chromSize);
			case CHROMOSOME9:
				return getSingletonChromosome9MapabilityIntervalTree(chromSize);
			case CHROMOSOME10:
				return getSingletonChromosome10MapabilityIntervalTree(chromSize);
			case CHROMOSOME11:
				return getSingletonChromosome11MapabilityIntervalTree(chromSize);
			case CHROMOSOME12:
				return getSingletonChromosome12MapabilityIntervalTree(chromSize);
			case CHROMOSOME13:
				return getSingletonChromosome13MapabilityIntervalTree(chromSize);
			case CHROMOSOME14:
				return getSingletonChromosome14MapabilityIntervalTree(chromSize);
			case CHROMOSOME15:
				return getSingletonChromosome15MapabilityIntervalTree(chromSize);
			case CHROMOSOME16:
				return getSingletonChromosome16MapabilityIntervalTree(chromSize);
			case CHROMOSOME17:
				return getSingletonChromosome17MapabilityIntervalTree(chromSize);
			case CHROMOSOME18:
				return getSingletonChromosome18MapabilityIntervalTree(chromSize);
			case CHROMOSOME19:
				return getSingletonChromosome19MapabilityIntervalTree(chromSize);
			case CHROMOSOME20:
				return getSingletonChromosome20MapabilityIntervalTree(chromSize);
			case CHROMOSOME21:
				return getSingletonChromosome21MapabilityIntervalTree(chromSize);
			case CHROMOSOME22:
				return getSingletonChromosome22MapabilityIntervalTree(chromSize);
			case CHROMOSOMEX:
				return getSingletonChromosomeXMapabilityIntervalTree(chromSize);
			case CHROMOSOMEY:
				return getSingletonChromosomeYMapabilityIntervalTree(chromSize);
	...
	public static void main(String[] args) {
		...
		// intervalTree =
		// getSingletonChromosomeBasedMapabilityIntervalTree(Commons.CHROMOSOME1,
		// chromSize);
