...
public class AnalysisofRSATResultsForRSIDsInFigures {
	...
	public static void analyzeRSATResultsForGivenRSIDs(
			List<String> rsIDList, 
			String RSATResults_InputFileName,
...
//						System.out.println(rsID);
					...
					if (rsIDList.contains(rsID)){
						...
						//how many of these rsIDs are common between rsIDs in RSAT results and Chen Yao's rsIDList in figures
				...
				}//End of IF: read strLine contains rsID  and does not contain "Description"	
