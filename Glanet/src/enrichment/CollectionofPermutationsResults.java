...
public class CollectionofPermutationsResults {
	...
	public static void writeResultsWRTZScorestoOutputFiles(
		...
		while (itr.hasNext()) {
			...
			if (annotationType.doKEGGPathwayAnnotation() || 
				...
				bufferedWriter.write(element.getNumber() + "\t" + element.getName() + "\t" + element.getOriginalNumberofOverlaps() + "\t" + element.getNumberofPermutationsHavingOverlapsGreaterThanorEqualtoOriginalNumberofOverlaps() + "\t" + numberofPermutations + "\t" + numberofComparisons + "\t" + element.getMean() + "\t" + element.getStdDev() + "\t" + element.getZScore() + "\t" + df.format(element.getEmpiricalPValueCalculatedFromZScore()) + "\t" + df.format(element.getBonferroniCorrectedPValueCalculatedFromZScore()) + "\t" + df.format(element.getBHFDRAdjustedPValueCalculatedFromZScore()) + "\t" + element.isRejectNullHypothesisCalculatedFromZScore() + "\t" +  df.format(element.getEmpiricalPValue()) + "\t" + df.format(element.getBonferroniCorrectedPValue()) + "\t" + df.format(element.getBHFDRAdjustedPValue()) + "\t" + element.isRejectNullHypothesis() + "\t");
				...
				// line per element in output file
				bufferedWriter.write(element.getNumber() + "\t" + element.getName() + "\t" + element.getOriginalNumberofOverlaps() + "\t" + element.getNumberofPermutationsHavingOverlapsGreaterThanorEqualtoOriginalNumberofOverlaps() + "\t" + numberofPermutations + "\t" + numberofComparisons + "\t" + element.getMean() + "\t" + element.getStdDev() + "\t" + element.getZScore() + "\t" + df.format(element.getEmpiricalPValueCalculatedFromZScore()) + "\t" + df.format(element.getBonferroniCorrectedPValueCalculatedFromZScore()) + "\t"  + df.format(element.getBHFDRAdjustedPValueCalculatedFromZScore()) + "\t" + element.isRejectNullHypothesisCalculatedFromZScore() + "\t" + df.format(element.getEmpiricalPValue()) + "\t" + df.format(element.getBonferroniCorrectedPValue()) + "\t" + df.format(element.getBHFDRAdjustedPValue()) + "\t" + element.isRejectNullHypothesis() + System.getProperty("line.separator"));
	...
	public static void writeResultstoOutputFiles(String outputFolder, String fileName, String jobName, List<FunctionalElement> list, AnnotationType annotationType, MultipleTestingType multipleTestingParameter, float bonferroniCorrectionSignigicanceLevel, float FDR, int numberofPermutations, int numberofComparisons) throws IOException {
		BufferedWriter bufferedWriter = null;
		FunctionalElement element = null;
	...
	public static void collectPermutationResults(
		...
		double stdDev = 0f;
		double zScore = 0f;
		double empiricalPValueCalculatedFromZScore = 0f; 
		...
		try {
			...
			for(TLongIntIterator it = elementNumber2OriginalNumberofOverlaps.iterator(); it.hasNext();){
				...
				if (bonferroniCorrectedPValueCalculatedFromZScore > 1f){
					element.setBonferroniCorrectedPValueCalculatedFromZScore(1f);
				}else{
...
//			/****************************************************************************************************************************/
//			/*****SORT w.r.t. #ofPermutationsHavingOverlapsGreaterThanorEqualtoOriginalNumberofOverlaps in ascending order starts********/
...
//			Collections.sort(list, FunctionalElement.NUMBER_OF_PERMUTATIONS_HAVING_OVERLAPS_GREATER_THAN_EQUAL_TO_ORIGINAL_NUMBER_OF_OVERLAPS);
//			/****************************************************************************************************************************/
//			/*****SORT w.r.t. #ofPermutationsHavingOverlapsGreaterThanorEqualtoOriginalNumberofOverlaps in ascending order ends**********/
...
//			/****************************************************************************************************************************/
//			/*****Write w.r.t. zScore in descending order starts*************************************************************************/
//			/****************************************************************************************************************************/
...
//			
//			//Header Line
//			bufferedWriter.write("elementNumber" + "\t" +  "elementName" +  "\t" + "originalNumberofElements" + "\t"  + "mean"+ "\t" + "stdDev" +  "\t" + "NumberofPermutationsHavingOverlapsGreaterThanorEqualtoOriginalNumberofOverlaps"  + "\t" + "zScore"   + "\t" + "pValueCalculatedFromZScore" +  "\t" + "bonferroniCorrectedPValueCalculatedFromZScore" + "\t" +  "BHFDRAdjustedPValueCalculatedFromZScore" +  "\t" +  "RejectNullHypothesisFromZScore" + System.getProperty("line.separator"));
//			
//			for(Iterator<FunctionalElement> it = list.iterator(); it.hasNext();){
//				
//				element = it.next();
//				
//				bufferedWriter.write(element.getNumber() + "\t" + element.getName() + "\t"+ element.getOriginalNumberofOverlaps() + "\t"  + element.getMean() + "\t" + element.getStdDev() +  "\t" +  element.getNumberofPermutationsHavingOverlapsGreaterThanorEqualtoOriginalNumberofOverlaps() + "\t" + df.format(element.getZScore()) + "\t" + df.format(element.getEmpiricalPValueCalculatedFromZScore())+ "\t" + df.format(element.getBonferroniCorrectedPValueCalculatedFromZScore()) +  "\t" + df.format(element.getBHFDRAdjustedPValueFromZScore()) + "\t" + element.isRejectNullHypothesisFromZScore() + System.getProperty("line.separator"));
//				
//			}//End of for 
//			
...
//			bufferedWriter.close();
//			/****************************************************************************************************************************/
//			/*****Write w.r.t. zScore in descending order ends***************************************************************************/
//			/****************************************************************************************************************************/
			...
			writeResultsWRTZScorestoOutputFiles(outputFolder, allFileName, jobName, list, annotationType, multipleTestingParameter, bonferroniCorrectionSignigicanceLevel, FDR, numberofPermutations, numberofComparisons);
			/************************************************************************************/
			/****************************** WRITE RESULTS ENDS **********************************/
			/************************************************************************************/
	...
	public static void main(String[] args) {
		...
		if (userDefinedGeneSetAnnotationType.doUserDefinedGeneSetAnnotation()) {
			...
			CollectionofPermutationsResults.collectPermutationResults(numberofPermutationsInEachRun, bonferroniCorrectionSignificanceLevel, FDR, multipleTestingParameter, dataFolder, outputFolder, Commons.ENRICHMENT_DIRECTORY + System.getProperty("file.separator") + Commons.USER_DEFINED_GENESET + System.getProperty("file.separator") + userDefinedGeneSetName + System.getProperty("file.separator") + Commons.EXON_BASED + System.getProperty("file.separator") + Commons.RUNS_DIRECTORY + Commons.EXON_BASED_USER_DEFINED_GENESET + "_" + userDefinedGeneSetName, Commons.ENRICHMENT_DIRECTORY + System.getProperty("file.separator") + Commons.USER_DEFINED_GENESET + System.getProperty("file.separator") + userDefinedGeneSetName + System.getProperty("file.separator") + Commons.EXON_BASED + System.getProperty("file.separator") + Commons.EXON_BASED_USER_DEFINED_GENESET + "_" + userDefinedGeneSetName, jobName, numberofRuns, numberofRemainders, numberofComparisons.getExonBasedUserDefinedGeneSetNumberofComparison(), userDefinedGeneSetAnnotationType, userDefinedGeneSetDescriptionOptionalInputFile, null, GeneratedMixedNumberDescriptionOrderLength.INT_5DIGIT_USERDEFINEDGENESETNUMBER);

			CollectionofPermutationsResults.collectPermutationResults(numberofPermutationsInEachRun, bonferroniCorrectionSignificanceLevel, FDR, multipleTestingParameter, dataFolder, outputFolder, Commons.ENRICHMENT_DIRECTORY + System.getProperty("file.separator") + Commons.USER_DEFINED_GENESET + System.getProperty("file.separator") + userDefinedGeneSetName + System.getProperty("file.separator") + Commons.REGULATION_BASED + System.getProperty("file.separator") + Commons.RUNS_DIRECTORY + Commons.REGULATION_BASED_USER_DEFINED_GENESET + "_" + userDefinedGeneSetName, Commons.ENRICHMENT_DIRECTORY + System.getProperty("file.separator") + Commons.USER_DEFINED_GENESET + System.getProperty("file.separator") + userDefinedGeneSetName + System.getProperty("file.separator") + Commons.REGULATION_BASED + System.getProperty("file.separator") + Commons.REGULATION_BASED_USER_DEFINED_GENESET + "_" + userDefinedGeneSetName, jobName, numberofRuns, numberofRemainders, numberofComparisons.getRegulationBasedUserDefinedGeneSetNumberofComparison(), userDefinedGeneSetAnnotationType, userDefinedGeneSetDescriptionOptionalInputFile, null, GeneratedMixedNumberDescriptionOrderLength.INT_5DIGIT_USERDEFINEDGENESETNUMBER);

			CollectionofPermutationsResults.collectPermutationResults(numberofPermutationsInEachRun, bonferroniCorrectionSignificanceLevel, FDR, multipleTestingParameter, dataFolder, outputFolder, Commons.ENRICHMENT_DIRECTORY + System.getProperty("file.separator") + Commons.USER_DEFINED_GENESET + System.getProperty("file.separator") + userDefinedGeneSetName + System.getProperty("file.separator") + Commons.ALL_BASED + System.getProperty("file.separator") + Commons.RUNS_DIRECTORY + Commons.ALL_BASED_USER_DEFINED_GENESET + "_" + userDefinedGeneSetName, Commons.ENRICHMENT_DIRECTORY + System.getProperty("file.separator") + Commons.USER_DEFINED_GENESET + System.getProperty("file.separator") + userDefinedGeneSetName + System.getProperty("file.separator") + Commons.ALL_BASED + System.getProperty("file.separator") + Commons.ALL_BASED_USER_DEFINED_GENESET + "_" + userDefinedGeneSetName, jobName, numberofRuns, numberofRemainders, numberofComparisons.getAllBasedUserDefinedGeneSetNumberofComparison(), userDefinedGeneSetAnnotationType, userDefinedGeneSetDescriptionOptionalInputFile, null, GeneratedMixedNumberDescriptionOrderLength.INT_5DIGIT_USERDEFINEDGENESETNUMBER);
		...
		if (userDefinedLibraryAnnotationType.doUserDefinedLibraryAnnotation()) {
			...
			for (TIntObjectIterator<String> it = elementTypeNumber2ElementTypeMap.iterator(); it.hasNext();) {
				...
				CollectionofPermutationsResults.collectPermutationResults(numberofPermutationsInEachRun, bonferroniCorrectionSignificanceLevel, FDR, multipleTestingParameter, dataFolder, outputFolder, Commons.TO_BE_COLLECTED_USER_DEFINED_LIBRARY_NUMBER_OF_OVERLAPS + elementType + System.getProperty("file.separator") + Commons.RUNS_DIRECTORY, Commons.TO_BE_COLLECTED_USER_DEFINED_LIBRARY_NUMBER_OF_OVERLAPS + elementType + System.getProperty("file.separator"), jobName, numberofRuns, numberofRemainders, numberofComparisons.getUserDefinedLibraryElementTypeNumber2NumberofComparisonMap().get(elementTypeNumber), userDefinedLibraryAnnotationType, null, elementType, GeneratedMixedNumberDescriptionOrderLength.INT_6DIGIT_ELEMENTNUMBER);
		...
		if (tfKeggPathwayAnnotationType.doTFKEGGPathwayAnnotation() && !(tfCellLineKeggPathwayAnnotationType.doTFCellLineKEGGPathwayAnnotation())) {
			...
			CollectionofPermutationsResults.collectPermutationResults(numberofPermutationsInEachRun, bonferroniCorrectionSignificanceLevel, FDR, multipleTestingParameter, dataFolder, outputFolder, Commons.TO_BE_COLLECTED_EXON_BASED_KEGG_PATHWAY_NUMBER_OF_OVERLAPS, Commons.ALL_PERMUTATIONS_NUMBER_OF_OVERLAPS_FOR_EXON_BASED_KEGG_PATHWAY, jobName, numberofRuns, numberofRemainders, numberofComparisons.getExonBasedKEGGPathwayNumberofComparison(), AnnotationType.DO_KEGGPATHWAY_ANNOTATION, null, null, GeneratedMixedNumberDescriptionOrderLength.INT_4DIGIT_KEGGPATHWAYNUMBER);
			CollectionofPermutationsResults.collectPermutationResults(numberofPermutationsInEachRun, bonferroniCorrectionSignificanceLevel, FDR, multipleTestingParameter, dataFolder, outputFolder, Commons.TO_BE_COLLECTED_REGULATION_BASED_KEGG_PATHWAY_NUMBER_OF_OVERLAPS, Commons.ALL_PERMUTATIONS_NUMBER_OF_OVERLAPS_FOR_REGULATION_BASED_KEGG_PATHWAY, jobName, numberofRuns, numberofRemainders, numberofComparisons.getRegulationBasedKEGGPathwayNumberofComparison(), AnnotationType.DO_KEGGPATHWAY_ANNOTATION, null, null, GeneratedMixedNumberDescriptionOrderLength.INT_4DIGIT_KEGGPATHWAYNUMBER);
			CollectionofPermutationsResults.collectPermutationResults(numberofPermutationsInEachRun, bonferroniCorrectionSignificanceLevel, FDR, multipleTestingParameter, dataFolder, outputFolder, Commons.TO_BE_COLLECTED_ALL_BASED_KEGG_PATHWAY_NUMBER_OF_OVERLAPS, Commons.ALL_PERMUTATIONS_NUMBER_OF_OVERLAPS_FOR_ALL_BASED_KEGG_PATHWAY, jobName, numberofRuns, numberofRemainders, numberofComparisons.getAllBasedKEGGPathwayNumberofComparison(), AnnotationType.DO_KEGGPATHWAY_ANNOTATION, null, null, GeneratedMixedNumberDescriptionOrderLength.INT_4DIGIT_KEGGPATHWAYNUMBER);

			CollectionofPermutationsResults.collectPermutationResults(numberofPermutationsInEachRun, bonferroniCorrectionSignificanceLevel, FDR, multipleTestingParameter, dataFolder, outputFolder, Commons.TO_BE_COLLECTED_TF_EXON_BASED_KEGG_PATHWAY_NUMBER_OF_OVERLAPS, Commons.ALL_PERMUTATIONS_NUMBER_OF_OVERLAPS_FOR_TF_EXON_BASED_KEGG_PATHWAY, jobName, numberofRuns, numberofRemainders, numberofComparisons.getTfExonBasedKEGGPathwayNumberofComparison(), AnnotationType.DO_TF_KEGGPATHWAY_ANNOTATION, null, null, GeneratedMixedNumberDescriptionOrderLength.INT_4DIGIT_TFNUMBER_4DIGIT_KEGGPATHWAYNUMBER);
			CollectionofPermutationsResults.collectPermutationResults(numberofPermutationsInEachRun, bonferroniCorrectionSignificanceLevel, FDR, multipleTestingParameter, dataFolder, outputFolder, Commons.TO_BE_COLLECTED_TF_REGULATION_BASED_KEGG_PATHWAY_NUMBER_OF_OVERLAPS, Commons.ALL_PERMUTATIONS_NUMBER_OF_OVERLAPS_FOR_TF_REGULATION_BASED_KEGG_PATHWAY, jobName, numberofRuns, numberofRemainders, numberofComparisons.getTfRegulationBasedKEGGPathwayNumberofComparison(), AnnotationType.DO_TF_KEGGPATHWAY_ANNOTATION, null, null, GeneratedMixedNumberDescriptionOrderLength.INT_4DIGIT_TFNUMBER_4DIGIT_KEGGPATHWAYNUMBER);
