...
public class ChromosomeBasedMapabilityArray {
	...
	public static MapabilityFloatArray getChromosomeMapabilityArray( String dataFolder, ChromosomeName chromName,
			int chromSize) {
	...
	public static MapabilityFloatArray getChr1Mapability( String dataFolder, int chromSize) {
		...
		Mapability.fillChromBasedMapabilityArray( dataFolder, chromSize, ChromosomeName.CHROMOSOME1,
	...
	public static MapabilityFloatArray getChr2Mapability( String dataFolder, int chromSize) {
		...
		MapabilityFloatArray mapabilityFloatArray = new MapabilityFloatArray( chromSize);
		Mapability.fillChromBasedMapabilityArray( dataFolder, chromSize, ChromosomeName.CHROMOSOME2,
				mapabilityFloatArray);
		return mapabilityFloatArray;
	}
	...
	public static MapabilityFloatArray getChr3Mapability( String dataFolder, int chromSize) {
		...
		MapabilityFloatArray mapabilityFloatArray = new MapabilityFloatArray( chromSize);
		Mapability.fillChromBasedMapabilityArray( dataFolder, chromSize, ChromosomeName.CHROMOSOME3,
				mapabilityFloatArray);
		return mapabilityFloatArray;
	}
	...
	public static MapabilityFloatArray getChr4Mapability( String dataFolder, int chromSize) {
		...
		MapabilityFloatArray mapabilityFloatArray = new MapabilityFloatArray( chromSize);
		Mapability.fillChromBasedMapabilityArray( dataFolder, chromSize, ChromosomeName.CHROMOSOME4,
				mapabilityFloatArray);
		return mapabilityFloatArray;
	}
	...
	public static MapabilityFloatArray getChr5Mapability( String dataFolder, int chromSize) {
		...
		MapabilityFloatArray mapabilityFloatArray = new MapabilityFloatArray( chromSize);
		Mapability.fillChromBasedMapabilityArray( dataFolder, chromSize, ChromosomeName.CHROMOSOME5,
				mapabilityFloatArray);
		return mapabilityFloatArray;
	}
	...
	public static MapabilityFloatArray getChr6Mapability( String dataFolder, int chromSize) {
		...
		MapabilityFloatArray mapabilityFloatArray = new MapabilityFloatArray( chromSize);
		Mapability.fillChromBasedMapabilityArray( dataFolder, chromSize, ChromosomeName.CHROMOSOME6,
				mapabilityFloatArray);
		return mapabilityFloatArray;
	}
	...
	public static MapabilityFloatArray getChr7Mapability( String dataFolder, int chromSize) {
		...
		MapabilityFloatArray mapabilityFloatArray = new MapabilityFloatArray( chromSize);
		Mapability.fillChromBasedMapabilityArray( dataFolder, chromSize, ChromosomeName.CHROMOSOME7,
				mapabilityFloatArray);
		return mapabilityFloatArray;
	}
	...
	public static MapabilityFloatArray getChr8Mapability( String dataFolder, int chromSize) {
		...
		MapabilityFloatArray mapabilityFloatArray = new MapabilityFloatArray( chromSize);
		Mapability.fillChromBasedMapabilityArray( dataFolder, chromSize, ChromosomeName.CHROMOSOME8,
				mapabilityFloatArray);
		return mapabilityFloatArray;
	}
	...
	public static MapabilityFloatArray getChr9Mapability( String dataFolder, int chromSize) {
		...
		MapabilityFloatArray mapabilityFloatArray = new MapabilityFloatArray( chromSize);
		Mapability.fillChromBasedMapabilityArray( dataFolder, chromSize, ChromosomeName.CHROMOSOME9,
				mapabilityFloatArray);
		return mapabilityFloatArray;
	}
	...
	public static MapabilityFloatArray getChr10Mapability( String dataFolder, int chromSize) {
		...
		MapabilityFloatArray mapabilityFloatArray = new MapabilityFloatArray( chromSize);
		Mapability.fillChromBasedMapabilityArray( dataFolder, chromSize, ChromosomeName.CHROMOSOME10,
				mapabilityFloatArray);
		return mapabilityFloatArray;
	}
	...
	public static MapabilityFloatArray getChr11Mapability( String dataFolder, int chromSize) {
		...
		MapabilityFloatArray mapabilityFloatArray = new MapabilityFloatArray( chromSize);
		Mapability.fillChromBasedMapabilityArray( dataFolder, chromSize, ChromosomeName.CHROMOSOME11,
				mapabilityFloatArray);
		return mapabilityFloatArray;
	}
	...
	public static MapabilityFloatArray getChr12Mapability( String dataFolder, int chromSize) {
		...
		MapabilityFloatArray mapabilityFloatArray = new MapabilityFloatArray( chromSize);
		Mapability.fillChromBasedMapabilityArray( dataFolder, chromSize, ChromosomeName.CHROMOSOME12,
				mapabilityFloatArray);
		return mapabilityFloatArray;
	}
	...
	public static MapabilityFloatArray getChr13Mapability( String dataFolder, int chromSize) {
		...
		MapabilityFloatArray mapabilityFloatArray = new MapabilityFloatArray( chromSize);
		Mapability.fillChromBasedMapabilityArray( dataFolder, chromSize, ChromosomeName.CHROMOSOME13,
				mapabilityFloatArray);
		return mapabilityFloatArray;
	}
	...
	public static MapabilityFloatArray getChr14Mapability( String dataFolder, int chromSize) {
		...
		MapabilityFloatArray mapabilityFloatArray = new MapabilityFloatArray( chromSize);
		Mapability.fillChromBasedMapabilityArray( dataFolder, chromSize, ChromosomeName.CHROMOSOME14,
				mapabilityFloatArray);
		return mapabilityFloatArray;
	}
	...
	public static MapabilityFloatArray getChr15Mapability( String dataFolder, int chromSize) {
		...
		MapabilityFloatArray mapabilityFloatArray = new MapabilityFloatArray( chromSize);
		Mapability.fillChromBasedMapabilityArray( dataFolder, chromSize, ChromosomeName.CHROMOSOME15,
				mapabilityFloatArray);
		return mapabilityFloatArray;
	}
	...
	public static MapabilityFloatArray getChr16Mapability( String dataFolder, int chromSize) {
		...
		MapabilityFloatArray mapabilityFloatArray = new MapabilityFloatArray( chromSize);
		Mapability.fillChromBasedMapabilityArray( dataFolder, chromSize, ChromosomeName.CHROMOSOME16,
				mapabilityFloatArray);
		return mapabilityFloatArray;
	}
	...
	public static MapabilityFloatArray getChr17Mapability( String dataFolder, int chromSize) {
		...
		MapabilityFloatArray mapabilityFloatArray = new MapabilityFloatArray( chromSize);
		Mapability.fillChromBasedMapabilityArray( dataFolder, chromSize, ChromosomeName.CHROMOSOME17,
				mapabilityFloatArray);
		return mapabilityFloatArray;
	}
	...
	public static MapabilityFloatArray getChr18Mapability( String dataFolder, int chromSize) {
		...
		MapabilityFloatArray mapabilityFloatArray = new MapabilityFloatArray( chromSize);
		Mapability.fillChromBasedMapabilityArray( dataFolder, chromSize, ChromosomeName.CHROMOSOME18,
				mapabilityFloatArray);
		return mapabilityFloatArray;
	}
	...
	public static MapabilityFloatArray getChr19Mapability( String dataFolder, int chromSize) {
		...
		MapabilityFloatArray mapabilityFloatArray = new MapabilityFloatArray( chromSize);
		Mapability.fillChromBasedMapabilityArray( dataFolder, chromSize, ChromosomeName.CHROMOSOME19,
				mapabilityFloatArray);
		return mapabilityFloatArray;
	}
	...
	public static MapabilityFloatArray getChr20Mapability( String dataFolder, int chromSize) {
		...
		MapabilityFloatArray mapabilityFloatArray = new MapabilityFloatArray( chromSize);
		Mapability.fillChromBasedMapabilityArray( dataFolder, chromSize, ChromosomeName.CHROMOSOME20,
				mapabilityFloatArray);
		return mapabilityFloatArray;
	}
	...
	public static MapabilityFloatArray getChr21Mapability( String dataFolder, int chromSize) {
		...
		MapabilityFloatArray mapabilityFloatArray = new MapabilityFloatArray( chromSize);
		Mapability.fillChromBasedMapabilityArray( dataFolder, chromSize, ChromosomeName.CHROMOSOME21,
				mapabilityFloatArray);
		return mapabilityFloatArray;
	}
	...
	public static MapabilityFloatArray getChr22Mapability( String dataFolder, int chromSize) {
		...
		MapabilityFloatArray mapabilityFloatArray = new MapabilityFloatArray( chromSize);
		Mapability.fillChromBasedMapabilityArray( dataFolder, chromSize, ChromosomeName.CHROMOSOME22,
				mapabilityFloatArray);
		return mapabilityFloatArray;
	}
	...
	public static MapabilityFloatArray getChrXMapability( String dataFolder, int chromSize) {
		...
		MapabilityFloatArray mapabilityFloatArray = new MapabilityFloatArray( chromSize);
		Mapability.fillChromBasedMapabilityArray( dataFolder, chromSize, ChromosomeName.CHROMOSOMEX,
				mapabilityFloatArray);
		return mapabilityFloatArray;
	}
	...
	public static MapabilityFloatArray getChrYMapability( String dataFolder, int chromSize) {
		...
		MapabilityFloatArray mapabilityFloatArray = new MapabilityFloatArray( chromSize);
		Mapability.fillChromBasedMapabilityArray( dataFolder, chromSize, ChromosomeName.CHROMOSOMEY,
				mapabilityFloatArray);
		return mapabilityFloatArray;
	}
