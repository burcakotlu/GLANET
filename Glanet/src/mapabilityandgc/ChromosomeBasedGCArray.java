...
public class ChromosomeBasedGCArray {
	...
	public static GCCharArray getChromosomeGCArray(String dataFolder, ChromosomeName chromName, int chromSize) {
		switch (chromName) {
			...
			case CHROMOSOME1:
				return getChr1GC(dataFolder, chromSize);
			case CHROMOSOME2:
				return getChr2GC(dataFolder, chromSize);
			case CHROMOSOME3:
				return getChr3GC(dataFolder, chromSize);
			case CHROMOSOME4:
				return getChr4GC(dataFolder, chromSize);
			case CHROMOSOME5:
				return getChr5GC(dataFolder, chromSize);
			case CHROMOSOME6:
				return getChr6GC(dataFolder, chromSize);
			case CHROMOSOME7:
				return getChr7GC(dataFolder, chromSize);
			case CHROMOSOME8:
				return getChr8GC(dataFolder, chromSize);
			case CHROMOSOME9:
				return getChr9GC(dataFolder, chromSize);
			case CHROMOSOME10:
				return getChr10GC(dataFolder, chromSize);
			case CHROMOSOME11:
				return getChr11GC(dataFolder, chromSize);
			case CHROMOSOME12:
				return getChr12GC(dataFolder, chromSize);
			case CHROMOSOME13:
				return getChr13GC(dataFolder, chromSize);
			case CHROMOSOME14:
				return getChr14GC(dataFolder, chromSize);
			case CHROMOSOME15:
				return getChr15GC(dataFolder, chromSize);
			case CHROMOSOME16:
				return getChr16GC(dataFolder, chromSize);
			case CHROMOSOME17:
				return getChr17GC(dataFolder, chromSize);
			case CHROMOSOME18:
				return getChr18GC(dataFolder, chromSize);
			case CHROMOSOME19:
				return getChr19GC(dataFolder, chromSize);
			case CHROMOSOME20:
				return getChr20GC(dataFolder, chromSize);
			case CHROMOSOME21:
				return getChr21GC(dataFolder, chromSize);
			case CHROMOSOME22:
				return getChr22GC(dataFolder, chromSize);
			case CHROMOSOMEX:
				return getChrXGC(dataFolder, chromSize);
			case CHROMOSOMEY:
				return getChrYGC(dataFolder, chromSize);
			default:
				break;
		}
