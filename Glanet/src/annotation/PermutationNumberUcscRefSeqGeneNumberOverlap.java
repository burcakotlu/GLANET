...
public class PermutationNumberUcscRefSeqGeneNumberOverlap {
	...
	public PermutationNumberUcscRefSeqGeneNumberOverlap(int permutationNumber, int refSeqGeneNumber, IntervalName intervalName, int intervalNumber, int geneHugoSymbolNumber, int geneEntrezId, int low, int high, TShortList keggPathwayNumberList) {
		super();
		this.permutationNumber = permutationNumber;
		this.refSeqGeneNumber = refSeqGeneNumber;
		this.intervalName = intervalName;
