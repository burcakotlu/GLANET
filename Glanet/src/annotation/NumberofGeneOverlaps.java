...
public class NumberofGeneOverlaps {
	...
	public void calculate(){
		totalNumberofOverlaps = numberofExonOverlaps +
								numberofIntronOverlaps +
								numberof5p1Overlaps + 
								numberof5p2Overlaps +
								numberof5dOverlaps +
								numberof3p1Overlaps + 
		...
		allPercentage = exonPercentage + intronPercentage + 
				fivep1Percentage + fivep2Percentage + fivedPercentage +
				threep1Percentage + threep2Percentage + threedPercentage;
