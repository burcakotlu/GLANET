...
public class SimulationGLANETResults {
	...
	public static FunctionalElementMinimal getElement(
		...
		//ElementNumber	ElementName	OriginalNumberofOverlaps	NumberofPermutationsHavingNumberofOverlapsGreaterThanorEqualToIn10000Permutations	NumberofPermutations	NumberofcomparisonsforBonferroniCorrection	mean	stdDev	zScore	empiricalPValueCalculatedFromZScore	BonferroniCorrectedPValueCalculatedFromZScore	BHFDRAdjustedPValueCalculatedFromZScore	RejectNullHypothesisCalculatedFromZScore	empiricalPValue	BonfCorrPValuefor406Comparisons	BHFDRAdjustedPValue	RejectNullHypothesisforanFDRof0.05
		//1090066	HAE2F1_MCF7	13	0	10000	406	3.2922226855713106	1.6902789833744583	5.743298834047009	4.642483E-9	1.884848E-6	5.470056E-8	true	0E0	0E0	0E0	true
			...
			switch(enrichmentDecision){
				...
				case P_VALUE_CALCULATED_FROM_Z_SCORE_AND_NUMBER_OF_PERMUTATIONS_RATIO: 
					cellLineFilteredEnrichmentBufferedWriter.write(	
							...
							"zScore" + "\t" +
							"EmpiricalPValueCalculatedFromZScore" + "\t" + 
							"BonferroniCorrectedPValueCalculatedFromZScore" + "\t" + 
							"BHFDRAdjustedPValueCalculatedFromZScore" + "\t" + 
							"isRejectNullHypothesisCalculatedFromZScore" + "\t" + 
	...
	public static void readSimulationGLANETResults(
		...
		try {
			...
			for(int i = 0; i<numberofSimulations; i++){
				...
				numberofSimulationsThatHasElementNameCellLineNameEnriched += writeNewEnrichmentFile(
						elementList,
	...
	public static void main(String[] args) {
		...
		readSimulationGLANETResults(outputFolder,tpmString,dnaseOverlapsExcludedorNot,numberofSimulations,numberofHistoneElementsInCellLine,ElementType.HISTONE,Commons.GM12878,Commons.H3K27ME3_GM12878,bonferroniCorrectionSignificanceLevel,FDR, multipleTestingParameter,enrichmentDecision);
