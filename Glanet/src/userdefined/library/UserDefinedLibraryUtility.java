...
public class UserDefinedLibraryUtility {
	...
	public static void fillElementTypeNumberBasedMaps(
			TIntObjectMap<TIntObjectMap<TIntList>> elementTypeNumber2ElementNumber2AllKMap,
	...
	public static void readUserDefinedLibraryInputFileCreateUnsortedChromosomeBasedFilesWithNumbersFillMapsWriteMaps(
		...
		try{
			...
			while( ( strLine = bufferedReader.readLine()) != null){
				...
				if( !strLine.startsWith( "!")){
					...
					if( elementName2ElementNumberMap == null){
						...
						elementTypeNumber2ElementName2ElementNumberMapMap.put( currentElementTypeNumber,
								elementName2ElementNumberMap);
					}
					...
					if( elementNumber2ElementNameMap == null){
						...
						elementTypeNumber2ElementNumber2ElementNameMapMap.put( currentElementTypeNumber,
			...
			FileOperations.writeName2NumberMap( dataFolder, userDefinedLibraryElementType2ElementTypeNumberMap,
					...
					Commons.ALL_POSSIBLE_USERDEFINEDLIBRARY_ELEMENTTYPE_NAME_2_NUMBER_OUTPUT_FILENAME);
			FileOperations.writeName2NumberMap( dataFolder, userDefinedLibraryFileName2FileNumberMap,
					Commons.ALL_POSSIBLE_NAMES_USERDEFINEDLIBRARY_OUTPUT_DIRECTORYNAME,
					Commons.ALL_POSSIBLE_USERDEFINEDLIBRARY_FILE_NAME_2_NUMBER_OUTPUT_FILENAME);

			FileOperations.writeSortedNumber2NameMap( dataFolder, userDefinedLibraryElementTypeNumber2ElementTypeMap,
					Commons.ALL_POSSIBLE_NAMES_USERDEFINEDLIBRARY_OUTPUT_DIRECTORYNAME,
					Commons.ALL_POSSIBLE_USERDEFINEDLIBRARY_ELEMENTTYPE_NUMBER_2_NAME_OUTPUT_FILENAME);
			FileOperations.writeSortedNumber2NameMap( dataFolder, userDefinedLibraryFileNumber2FileNameMap,
					Commons.ALL_POSSIBLE_NAMES_USERDEFINEDLIBRARY_OUTPUT_DIRECTORYNAME,
					Commons.ALL_POSSIBLE_USERDEFINEDLIBRARY_FILE_NUMBER_2_NAME_OUTPUT_FILENAME);
			...
			for( TIntObjectIterator<TObjectIntMap<String>> it = elementTypeNumber2ElementName2ElementNumberMapMap.iterator(); it.hasNext();){
				...
				FileOperations.writeName2NumberMap(
						...
						Commons.ALL_POSSIBLE_USERDEFINEDLIBRARY_ELEMENT_NAME_2_NUMBER_OUTPUT_FILENAME);
			...
			for( TIntObjectIterator<TIntObjectMap<String>> it = elementTypeNumber2ElementNumber2ElementNameMapMap.iterator(); it.hasNext();){
				...
				// ElementType
				elementType = userDefinedLibraryElementTypeNumber2ElementTypeMap.get( it.key());
				FileOperations.writeNumber2NameMap(
						dataFolder,
						it.value(),
						Commons.ALL_POSSIBLE_NAMES_USERDEFINEDLIBRARY_OUTPUT_DIRECTORYNAME + elementType + System.getProperty( "file.separator"),
