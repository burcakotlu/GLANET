...
public class UcscRefSeqGeneIntervalTreeNodeWithNumbers extends IntervalTreeNode {
	...
	public UcscRefSeqGeneIntervalTreeNodeWithNumbers(char strand, int refSeqGeneNumber, int geneEntrezId, int geneHugoSymbolNumber, IntervalName intervalName, int intervalNumber) {
