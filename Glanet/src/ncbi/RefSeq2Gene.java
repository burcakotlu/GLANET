...
public class RefSeq2Gene {
	...
	// may be null (-) if a RefSeq was provided after the genomic accession was
	// submitted
	...
	public void setRNA_Nucleotide_Accession_WithVersion(String rNA_Nucleotide_Accession_WithVersion) {
	...
	public boolean equals(Object obj) {
		...
		if (obj != null) {
			if (this.getClass() == obj.getClass()) {
				...
				if ((refSeq2Gene.getGeneId().equals(this.getGeneId())) && (refSeq2Gene.getRNA_Nucleotide_Accession().equals(this.getRNA_Nucleotide_Accession())) && (refSeq2Gene.getRNA_Nucleotide_Accession_WithVersion().equals(this.getRNA_Nucleotide_Accession_WithVersion()))) {
					isEqual = true;
					return isEqual;
				}
			}
