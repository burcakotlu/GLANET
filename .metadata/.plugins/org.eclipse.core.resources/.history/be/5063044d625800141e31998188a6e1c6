...
public enum GeneratedMixedNumberDescriptionOrderLength {
	...
	INT_4DIGIT_USERDEFINEDGENESETNUMBER(2),
	...
	INT_5DIGITS_PERMUTATIONNUMBER_5DIGITS_USERDEFINEDGENESETNUMBER(9),
    ...
    */
	...
	/** An added method.  */
    public boolean is_INT_4DIGIT_USERDEFINEDGENESETNUMBER() {
        return  this == INT_4DIGIT_USERDEFINEDGENESETNUMBER;
    }
    ...
    public boolean is_INT_5DIGITS_PERMUTATIONNUMBER_5DIGITS_USERDEFINEDGENESETNUMBER() {
        return  this == INT_5DIGITS_PERMUTATIONNUMBER_5DIGITS_USERDEFINEDGENESETNUMBER;
    }
