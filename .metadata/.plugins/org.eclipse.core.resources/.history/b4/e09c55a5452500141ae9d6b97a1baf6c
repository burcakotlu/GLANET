					...
					for (UcscRefSeqGeneOverlapWithNumbers ucscRefSeqGeneOverlapWithNumbers: exonBasedKeggPathwayOverlapList){
						if(IntervalTree.overlaps(tfOverlap.getLow(),tfOverlap.getHigh(),ucscRefSeqGeneOverlapWithNumbers.getLow(),ucscRefSeqGeneOverlapWithNumbers.getHigh())){
							...
							for(TShortIterator it =  ucscRefSeqGeneOverlapWithNumbers.getKeggPathwayNumberList().iterator(); it.hasNext();){ 
										...
										bufferedWriter2.write(chromName + "\t" + interval.getLow() + "\t" + interval.getHigh() + "\t" + tfNumber2TfNameMap.get(tfNumber) + "_" + cellLineNumber2CellLineNameMap.get(cellLineNumber) + "\t"  + tfOverlap.getLow() + "\t" + tfOverlap.getHigh()  + "\t" +  refSeqGeneNumber2RefSeqGeneNameMap.get(ucscRefSeqGeneOverlapWithNumbers.getRefSeqGeneNumber()) + "\t" + ucscRefSeqGeneOverlapWithNumbers.getLow()+ "\t" + ucscRefSeqGeneOverlapWithNumbers.getHigh()  + "\t"  + ucscRefSeqGeneOverlapWithNumbers.getIntervalName() + "\t" + geneHugoSymbolNumber2GeneHugoSymbolNameMap.get(ucscRefSeqGeneOverlapWithNumbers.getGeneHugoSymbolNumber()) + "\t" + ucscRefSeqGeneOverlapWithNumbers.getGeneEntrezId()+ "\t" + keggPathwayNumber2KeggPathwayNameMap.get(keggPathwayNumber) + System.getProperty("line.separator"));
										bufferedWriter2.flush();
										/*************************************************************/
...
//		}
	...
	public void annotate(String[] args){
		...
		/******************************************************/
		/***************FILL NUMBER 2 NAME MAPS****************/
		/***************FILL NAME 2 NUMBER MAPS****************/
		/******************************************************/
		...
		/*****************************************************************************/
		/************Search input interval files for DNASE******starts****************/
		/*****************************************************************************/	
		Instant dnaseStart = Instant.now();
		Date dt = Date.from(dnaseStart);
	    GlanetRunner.appendLog("DNASE annotation starts: " + dt);
		...
		/*****************************************************************************/
		/************Search input interval files for DNASE*********ends***************/
		/*****************************************************************************/	
...
//		writeResults(tfbsNameandCellLineName2KMap, Commons.ANNOTATE_INTERVALS_TFBS_RESULTS_GIVEN_SEARCH_INPUT);
		...
		/*******************************************************************************/
		/************Search input interval files for TF************starts***************/
		/*******************************************************************************/	
		Instant transcriptionFactorStart = Instant.now();
		dt = Date.from(transcriptionFactorStart);
	    GlanetRunner.appendLog("TF annotation starts: " + dt);
		...
		Instant transcriptionFactorEnd = Instant.now();
		dt = Date.from(transcriptionFactorEnd);
	    GlanetRunner.appendLog("TF annotation ends: " + dt);
	    
	    GlanetRunner.appendLog("TF annotation took: " + Duration.between(transcriptionFactorStart, transcriptionFactorEnd).getSeconds() +" seconds");				
		/*******************************************************************************/
		/************Search input interval files for TF************ends*****************/
		/*******************************************************************************/
		
		/*******************************************************************************/
		/************Search input interval files for HISTONE*******starts***************/
		/*******************************************************************************/	
		Instant histoneStart = Instant.now();
		dt = Date.from(histoneStart);
	    GlanetRunner.appendLog("Histone annotation starts: " + dt);
	    ...
	    GlanetRunner.appendLog("Histone annotation ends: " + dt);
	    
	    GlanetRunner.appendLog("Histone annotation took: " + Duration.between(histoneStart, histoneEnd).getSeconds() +" seconds");				
		/*******************************************************************************/
		/************Search input interval files for HISTONE******ends******************/
		/*******************************************************************************/	
		
	    /*******************************************************************************/
		/************Search input interval files for KEGG PATHWAY********starts*********/
		/*******************************************************************************/	
	    Instant KEGGPathwayStart = Instant.now();
		dt = Date.from(KEGGPathwayStart);
	    GlanetRunner.appendLog("KEGG Pathway annotation starts: " + dt);
		...
		Instant KEGGPathwayEnd = Instant.now();
		dt = Date.from(KEGGPathwayEnd);
	    GlanetRunner.appendLog("KEGG Pathway annotation ends: " + dt);
	    
	    GlanetRunner.appendLog("KEGG Pathway annotation took: " + Duration.between(KEGGPathwayStart, KEGGPathwayEnd).getSeconds() +" seconds");
	    /*******************************************************************************/
		/************Search input interval files for KEGG PATHWAY*****ends**************/
		/*******************************************************************************/	
...
//			writeResults(allResultsKeggPathway2KMap, Commons.ANNOTATE_INTERVALS_ALL_BASED_KEGG_PATHWAY_RESULTS_GIVEN_SEARCH_INPUT);
	    ...
	    GlanetRunner.appendLog("TF and others analysis starts: " + dt);
		...
		dt = Date.from(tfEnd);
	    GlanetRunner.appendLog("TF and other analysis ends: " + dt);
	    GlanetRunner.appendLog("TF and other analysis took: " + Duration.between(tfStart, tfEnd).getSeconds() +" seconds");		
	    ...
	    GlanetRunner.appendLog("All analysis with numbers took: " + Duration.between(dnaseStart, tfEnd).getSeconds() +" seconds");		
