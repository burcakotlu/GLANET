...
public static String   createDirectory(String directoryName,String enrichmentType){
		...
		File directory = new File(directoryBase + System.getProperty("file.separator") + directoryName);
...
public static String takeComplementforeachAllele(String allele){
	...
	public static String convertSlashSeparatedAllelestoTabSeparatedAlleles(String observedAllelesSeparatedwithSlash){
		...
		int indexofFormerBackSlash = 0;
		int indexofLatterBackSlash = observedAllelesSeparatedwithSlash.indexOf('/');
		String allele;
		String observedAllelesSeparatedwithTabs = "";
		
		if (indexofFormerBackSlash>=0 && indexofLatterBackSlash >=0){
			
			allele = observedAllelesSeparatedwithSlash.substring(indexofFormerBackSlash, indexofLatterBackSlash);	
			
			indexofFormerBackSlash = indexofLatterBackSlash ;
			
			indexofLatterBackSlash = observedAllelesSeparatedwithSlash.indexOf('\\',indexofFormerBackSlash+1);
			
			observedAllelesSeparatedwithTabs = observedAllelesSeparatedwithTabs + allele + "\t";			
		}
		
		//for the last allele
		allele = observedAllelesSeparatedwithSlash.substring(indexofFormerBackSlash+1);	
		observedAllelesSeparatedwithTabs = observedAllelesSeparatedwithTabs + allele;
