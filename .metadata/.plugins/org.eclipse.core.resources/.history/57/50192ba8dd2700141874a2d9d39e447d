...
import jaxbxjctool.TfKeggPathwayGivenInterval;
...
//		}
	...
	public void annotate(String[] args){
		...
		if (tfKeggPathwayEnrichmentType.isTfGeneSetEnrichment() && !tfCellLineKeggPathwayEnrichmentType.isTfCellLineGeneSetEnrichment()){
		    ...
		    GlanetRunner.appendLog("TF KEGGPathway annotation starts: " + dt);
		    ...
		    GlanetRunner.appendLog("TF KEGGPathway annotation ends: " + dt);
		    GlanetRunner.appendLog("TF KEGGPathway annotation took: " + Duration.between(tfKEGGPathwayStart, tfKEGGPathwayEnd).getSeconds() +" seconds");		
		...
		if (tfCellLineKeggPathwayEnrichmentType.isTfCellLineGeneSetEnrichment() && !tfKeggPathwayEnrichmentType.isTfGeneSetEnrichment()){
		    ...
		    GlanetRunner.appendLog("TF CELLLINE KEGGPATHWAY annotation starts: " + dt);
			...
			GlanetRunner.appendLog("TF CELLLINE KEGGPATHWAY annotation ends: " + dt);
			GlanetRunner.appendLog("TF CELLLINE KEGGPATHWAY annotation took: " + Duration.between(tfCellLineKEGGPathwayStart, tfCellLineKEGGPathwayEnd).getSeconds() +" seconds");	    
