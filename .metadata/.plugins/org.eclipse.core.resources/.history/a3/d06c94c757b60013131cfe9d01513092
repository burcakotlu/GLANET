...
//						}
						...
						fileWriter = FileOperations.createFileWriter(Commons.ANNOTATE_PERMUTATIONS_FOR_HISTONE + Commons.PERMUTATION +repeatNumberReflectedPermutationNumber+ "\\"+ permutationNumberHistoneNameaCellLineName + ".txt",true);
	...
	public void findAllOverlappingHistoneIntervals(String outputFolder, IntervalTreeNode node, Interval interval, String chromName, Map<String,BufferedWriter> bufferedWriterHashMap, List<String> histoneNameList, Map<String,Integer> histoneNameandCellLineName2ZeroorOneMap){
		FileWriter fileWriter = null;
		BufferedWriter bufferedWriter = null;
		...
		String histoneNameandCellLine = node.getTfbsorHistoneName() + "_" + node.getCellLineName();
			...
			if((node.getLeft().isNotSentinel()) && (interval.getLow()<=node.getLeft().getMax())&& (node.getLeft().getMin() <= interval.getHigh())){
				findAllOverlappingHistoneIntervals(outputFolder,node.getLeft(),interval,chromName,bufferedWriterHashMap, histoneNameList,histoneNameandCellLineName2ZeroorOneMap);	
			}
			
			if((node.getRight().isNotSentinel()) && (interval.getLow()<=node.getRight().getMax()) && (node.getRight().getMin()<=interval.getHigh())){
				findAllOverlappingHistoneIntervals(outputFolder,node.getRight(),interval,chromName,bufferedWriterHashMap,histoneNameList,histoneNameandCellLineName2ZeroorOneMap);	
...
//						}
					...
					fileWriter = FileOperations.createFileWriter(Commons.ANNOTATE_PERMUTATIONS_FOR_TFBS + Commons.PERMUTATION + repeatNumberReflectedPermutationNumber+ "\\" + permutationNumberTfNameCellLineName + ".txt",true);
					bufferedWriter = new BufferedWriter(fileWriter);
...
//						}
					...
					fileWriter = FileOperations.createFileWriter(Commons.ANNOTATE_PERMUTATIONS_FOR_TFBS + Commons.PERMUTATION + repeatNumberReflectedPermutationNumber+ "\\" + permutationNumberTfbsNameCellLineName + ".txt",true);
					bufferedWriter = new BufferedWriter(fileWriter);
...
//		}
	...
	//For each search input line, each tfbs will have value 1 or 0
	//These 1 or 0's will be accumulated in tfbs2KMap
	public void findAllOverlappingTfbsIntervals(String outputFolder,IntervalTreeNode node, Interval interval, String chromName, Map<String,BufferedWriter> bufferedWriterHashMap, List<String> tfbsNameList, Map<String,Integer> tfbsNameandCellLineName2ZeroorOneMap, List<TfNameandCellLineNameOverlap> tfandCellLineOverlapList){
		FileWriter fileWriter = null;
		BufferedWriter bufferedWriter = null;
		...
		String tfbsNameandCellLineName = node.getTfbsorHistoneName() + "_" + node.getCellLineName();
			...
			if((node.getLeft().isNotSentinel()) && (interval.getLow()<=node.getLeft().getMax()) && (node.getLeft().getMin() <= interval.getHigh())){
				findAllOverlappingTfbsIntervals(outputFolder,node.getLeft(),interval,chromName, bufferedWriterHashMap,tfbsNameList,tfbsNameandCellLineName2ZeroorOneMap,tfandCellLineOverlapList);	
			}
			
			if((node.getRight().isNotSentinel()) && (interval.getLow()<=node.getRight().getMax()) && (node.getRight().getMin()<=interval.getHigh())){
				findAllOverlappingTfbsIntervals(outputFolder,node.getRight(),interval,chromName, bufferedWriterHashMap,tfbsNameList,tfbsNameandCellLineName2ZeroorOneMap,tfandCellLineOverlapList);	
			}		
	}
	//New Functionality added
...
//						}
						...
						fileWriter = FileOperations.createFileWriter(Commons.ANNOTATE_PERMUTATIONS_FOR_DNASE + Commons.PERMUTATION +repeatNumberReflectedPermutationNumber + "\\"+ permutationNumberDnaseCellLineName + ".txt",true);
						bufferedWriter = new BufferedWriter(fileWriter);
	...
	public void findAllOverlappingDnaseIntervals(String outputFolder,IntervalTreeNode node, Interval interval, String chromName, Map<String,BufferedWriter> bufferedWriterHashMap, List<String> dnaseCellLineNameList,Map<String,Integer> dnaseCellLine2OneorZeroMap){
		FileWriter fileWriter = null;
		BufferedWriter bufferedWriter = null;
			...
			if (overlaps(node.getLow(), node.getHigh(), interval.getLow(), interval.getHigh()) && dnaseCellLineNameList.contains(node.getCellLineName())){
				try {
					...
					if (bufferedWriter==null){
						fileWriter = FileOperations.createFileWriter(outputFolder + Commons.ANNOTATE_INTERVALS_USING_INTERVAL_TREE_OUTPUT_FILE_PATH_FOR_DNASE +"_" + node.getCellLineName() + ".txt");
						bufferedWriter = new BufferedWriter(fileWriter);
			...
			if((node.getLeft().isNotSentinel()) && (interval.getLow()<=node.getLeft().getMax()) && (node.getLeft().getMin() <= interval.getHigh())){
				findAllOverlappingDnaseIntervals(outputFolder,node.getLeft(),interval,chromName,bufferedWriterHashMap,dnaseCellLineNameList, dnaseCellLine2OneorZeroMap);	
			}
			
			if((node.getRight().isNotSentinel()) && (interval.getLow()<=node.getRight().getMax()) && (node.getRight().getMin()<=interval.getHigh())){
				findAllOverlappingDnaseIntervals(outputFolder,node.getRight(),interval,chromName,bufferedWriterHashMap,dnaseCellLineNameList,dnaseCellLine2OneorZeroMap);	
...
//											}
											...
											fileWriter = FileOperations.createFileWriter(Commons.ANNOTATE_PERMUTATIONS_FOR_EXON_BASED_KEGG_PATHWAY_ANALYSIS + Commons.PERMUTATION +repeatNumberReflectedPermutationNumber+ "\\" + Commons.PERMUTATION +repeatNumberReflectedPermutationNumber +"_exonBased_" + keggPathwayName + ".txt",true);
											bufferedWriter = new BufferedWriter(fileWriter);
...
//											}
											...
											fileWriter = FileOperations.createFileWriter(Commons.ANNOTATE_PERMUTATIONS_FOR_REGULATION_BASED_KEGG_PATHWAY_ANALYSIS  + Commons.PERMUTATION +repeatNumberReflectedPermutationNumber+ "\\"+ Commons.PERMUTATION + repeatNumberReflectedPermutationNumber + "_regulationBased_" + keggPathwayName + ".txt",true);
											bufferedWriter = new BufferedWriter(fileWriter);
											bufferedWriterHashMap.put(permutationNumberKeggPathwayName, bufferedWriter);
...
//										}
										...
										fileWriter = FileOperations.createFileWriter(Commons.ANNOTATE_PERMUTATIONS_FOR_ALL_BASED_KEGG_PATHWAY_ANALYSIS + Commons.PERMUTATION +repeatNumberReflectedPermutationNumber+ "\\" + Commons.PERMUTATION + repeatNumberReflectedPermutationNumber +"_all_" + keggPathwayName + ".txt",true);
										bufferedWriter = new BufferedWriter(fileWriter);
										bufferedWriterHashMap.put(permutationNumberKeggPathwayName, bufferedWriter);
...
//								}
								...
								fileWriter = FileOperations.createFileWriter(Commons.ANNOTATE_PERMUTATIONS_FOR_ALL_BASED_KEGG_PATHWAY_ANALYSIS + Commons.PERMUTATION +repeatNumberReflectedPermutationNumber+ "\\" + Commons.PERMUTATION +repeatNumberReflectedPermutationNumber +"_allBased_" + keggPathwayName + ".txt",true);
								bufferedWriter = new BufferedWriter(fileWriter);
						...
						if(keggPathWayListContainingThisGeneId!=null){
							...
							for(int i= 0; i<keggPathWayListContainingThisGeneId.size(); i++){
								...
								if (keggPathwayNameList.contains(keggPathwayName)){
									...
									if (bufferedWriter == null){
										fileWriter = FileOperations.createFileWriter(Commons.ANNOTATE_INTERVALS_USING_INTERVAL_TREE_OUTPUT_FILE_PATH_FOR_ALL_BASED_KEGG_PATHWAY_ANALYSIS +"_allBased_" + keggPathwayName + ".txt");
										bufferedWriter = new BufferedWriter(fileWriter);
		...
		if (node.isNotSentinel()){
			...
			if (Commons.NCBI_GENE_ID.equals(type)){
				if (overlaps(node.getLow(), node.getHigh(), interval.getLow(), interval.getHigh()) && nameorIdHashMap.containsKey(node.getGeneEntrezId().toString())){
					...
					if (bufferedWriter == null){
						fileWriter = FileOperations.createFileWriter(Commons.ANNOTATE_INTERVALS_USING_INTERVAL_TREE_OUTPUT_FILE_PATH_FOR_NCBI_GENE_ID +"_" +String.valueOf(node.getGeneEntrezId()) + ".txt");
						bufferedWriter = new BufferedWriter(fileWriter);
				...
				if (overlaps(node.getLow(), node.getHigh(), interval.getLow(), interval.getHigh()) &&nameorIdHashMap.containsKey(node.getRefSeqGeneName())){
						...
						if (bufferedWriter == null){
							fileWriter = FileOperations.createFileWriter(Commons.ANNOTATE_INTERVALS_USING_INTERVAL_TREE_OUTPUT_FILE_PATH_FOR_NCBI_RNA +"_" + node.getRefSeqGeneName() + ".txt");
							bufferedWriter = new BufferedWriter(fileWriter);
				...
				if (overlaps(node.getLow(), node.getHigh(), interval.getLow(), interval.getHigh()) && nameorIdHashMap.containsKey(node.getGeneHugoSymbol())){
						...
						if (bufferedWriter == null){
							fileWriter = FileOperations.createFileWriter(Commons.ANNOTATE_INTERVALS_USING_INTERVAL_TREE_OUTPUT_FILE_PATH_FOR_UCSC_GENE_ALTERNATE_NAME +"_" + node.getGeneHugoSymbol() + ".txt");
							bufferedWriter = new BufferedWriter(fileWriter);
