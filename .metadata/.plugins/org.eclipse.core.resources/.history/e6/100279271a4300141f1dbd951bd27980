...
//				Commons.INPUT_FILE_FORMAT_DBSNP_IDS_0_BASED_COORDINATES_START_INCLUSIVE_END_INCLUSIVE
		...
		dnaseEnrichment = new JCheckBox( "CellLine Based DNase Annotation");
		...
		histoneEnrichment = new JCheckBox( "CellLine Based Histone Annotation");
		...
		tfEnrichment = new JCheckBox( "CellLine Based TF Annotation");
		...
		//tfEnrichment added to annotationOptions
        keggPathwayEnrichment = new JCheckBox( "KEGG Pathway Annotation");
        ...
        tfAndKeggPathwayEnrichment = new JCheckBox( "TF And KEGG Pathway Annotation");
        ...
        cellLineBasedTfAndKeggPathwayEnrichment = new JCheckBox( "CellLine Based TF And KEGG Pathway Annotation");
