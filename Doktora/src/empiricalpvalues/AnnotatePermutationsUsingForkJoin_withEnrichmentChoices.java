...
//    			    intervalTree = null;	
	...
	public void writeToBePolledNumberofOverlaps(Map<String,Integer> originalElement2KMap, Map<String,List<Integer>> element2AllKMap,String toBePolledDirectoryName, String runNumber){
		String elementName;
		Integer originalNumberofOverlaps;
...
//		String writePermutationBasedAnnotationResultMode = Commons.WRITE_PERMUTATION_BASED_ANNOTATION_RESULT;
		...
		if(dnaseEnrichment.equals(Commons.DO_DNASE_ENRICHMENT)){
//			@todo results can be here written to files
			...
			annotateOneThousandPermutationsUsingForkJoin.writeToBePolledNumberofOverlaps(originalDnase2KMap,dnase2AllKMap,Commons.TO_BE_POLLED_DNASE_NUMBER_OF_OVERLAPS,runNumber);
		}
		...
		if (histoneEnrichment.equals(Commons.DO_HISTONE_ENRICHMENT)){
			...
			annotateOneThousandPermutationsUsingForkJoin.writeToBePolledNumberofOverlaps(originalHistone2KMap,histone2AllKMap,Commons.TO_BE_POLLED_HISTONE_NUMBER_OF_OVERLAPS,runNumber);
		}
		...
		if (tfKeggPathwayEnrichment.equals(Commons.DO_TF_KEGGPATHWAY_ENRICHMENT)){
			...
			//Write to be polled files
			annotateOneThousandPermutationsUsingForkJoin.writeToBePolledNumberofOverlaps(originalTfbs2KMap,tfbs2AllKMap,Commons.TO_BE_POLLED_TF_NUMBER_OF_OVERLAPS,runNumber);
			
			annotateOneThousandPermutationsUsingForkJoin.writeToBePolledNumberofOverlaps(originalExonBasedKeggPathway2KMap,exonBasedKeggPathway2AllKMap,Commons.TO_BE_POLLED_EXON_BASED_KEGG_PATHWAY_NUMBER_OF_OVERLAPS,runNumber);
			annotateOneThousandPermutationsUsingForkJoin.writeToBePolledNumberofOverlaps(originalRegulationBasedKeggPathway2KMap,regulationBasedKeggPathway2AllKMap,Commons.TO_BE_POLLED_REGULATION_BASED_KEGG_PATHWAY_NUMBER_OF_OVERLAPS,runNumber);
			annotateOneThousandPermutationsUsingForkJoin.writeToBePolledNumberofOverlaps(originalAllBasedKeggPathway2KMap,allBasedKeggPathway2AllKMap,Commons.TO_BE_POLLED_ALL_BASED_KEGG_PATHWAY_NUMBER_OF_OVERLAPS,runNumber);
			
			annotateOneThousandPermutationsUsingForkJoin.writeToBePolledNumberofOverlaps(originalTfExonBasedKeggPathway2KMap,tfExonBasedKeggPathway2AllKMap,Commons.TO_BE_POLLED_TF_EXON_BASED_KEGG_PATHWAY_NUMBER_OF_OVERLAPS,runNumber);
			annotateOneThousandPermutationsUsingForkJoin.writeToBePolledNumberofOverlaps(originalTfRegulationBasedKeggPathway2KMap,tfRegulationBasedKeggPathway2AllKMap,Commons.TO_BE_POLLED_TF_REGULATION_BASED_KEGG_PATHWAY_NUMBER_OF_OVERLAPS,runNumber);
			annotateOneThousandPermutationsUsingForkJoin.writeToBePolledNumberofOverlaps(originalTfAllBasedKeggPathway2KMap,tfAllBasedKeggPathway2AllKMap,Commons.TO_BE_POLLED_TF_ALL_BASED_KEGG_PATHWAY_NUMBER_OF_OVERLAPS,runNumber);
		...
		if(tfCellLineKeggPathwayEnrichment.equals(Commons.DO_TF_CELLLINE_KEGGPATHWAY_ENRICHMENT)){
			...
			annotateOneThousandPermutationsUsingForkJoin.writeToBePolledNumberofOverlaps(originalTfCellLineExonBasedKeggPathway2KMap,tfCellLineExonBasedKeggPathway2AllKMap,Commons.TO_BE_POLLED_TF_CELLLINE_EXON_BASED_KEGG_PATHWAY_NUMBER_OF_OVERLAPS,runNumber);
			annotateOneThousandPermutationsUsingForkJoin.writeToBePolledNumberofOverlaps(originalTfCellLineRegulationBasedKeggPathway2KMap,tfCellLineRegulationBasedKeggPathway2AllKMap,Commons.TO_BE_POLLED_TF_CELLLINE_REGULATION_BASED_KEGG_PATHWAY_NUMBER_OF_OVERLAPS,runNumber);
			annotateOneThousandPermutationsUsingForkJoin.writeToBePolledNumberofOverlaps(originalTfCellLineAllBasedKeggPathway2KMap,tfCellLineAllBasedKeggPathway2AllKMap,Commons.TO_BE_POLLED_TF_CELLLINE_ALL_BASED_KEGG_PATHWAY_NUMBER_OF_OVERLAPS,runNumber);
		}
		...
		//Benjamini and Hochberg controlling for FDR starts
		...
		//sort w.r.t. Benjamini and Hochberg FDR in descending order
		...
		//Write Significant elements after controlling for Benjamini and Hochberg FDR
		if(dnaseEnrichment.equals(Commons.DO_DNASE_ENRICHMENT)){
		...
		//Benjamini and Hochberg FDR ends
