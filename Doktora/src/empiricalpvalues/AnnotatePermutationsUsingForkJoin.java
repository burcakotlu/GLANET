...
//    			    intervalTree = null;	
	...
	public void writetoFile(List<FunctionalElement> list, String fileName, String empiricalPValueType, int NUMBER_OF_REPEATS, int NUMBER_OF_PERMUTATIONS, String generateRandomDataMode, String inputDataFileName){
		FileWriter fileWriter=null;
		BufferedWriter bufferedWriter;
		...
		try {
			...
			if (Commons.BONFERRONI_CORRECTED_EMPIRICAL_P_VALUE.equals(empiricalPValueType)){	
				bufferedWriter.write("Name" + "\t"+ "OriginalNumberofOverlaps" + "\t" + "NumberofPermutationsHavingOverlapsGreaterThanorEqualto" + "\t" + "NumberofPermutations" + "\t" + "NumberofComparisons" + "\t" + "BonfCorrEmpiricalPValue" + "\t"+ "EmpiricalPValue" + "\t" + "j/m*delta" + "\t" + "Significant for FDR" + "\n");	
			} else if(Commons.EMPIRICAL_P_VALUE.equals(empiricalPValueType)){
				bufferedWriter.write("Name" + "\t"+ "OriginalNumberofOverlaps" + "\t" + "NumberofPermutationsHavingOverlapsGreaterThanorEqualto" + "\t" + "NumberofPermutations" + "\t" + "NumberofComparisons" + "\t" + "EmpiricalPValue" + "\t"+ "BonfCorrEmpiricalPValue" + "\t" + "j/m*delta" + "\t" + "Significant for FDR" + "\n");	
			} else if (Commons.BENJAMINI_HOCHBERG_FDR.equals(empiricalPValueType)){
				bufferedWriter.write("Name" + "\t"+ "OriginalNumberofOverlaps" + "\t" + "NumberofPermutationsHavingOverlapsGreaterThanorEqualto" + "\t" + "NumberofPermutations" + "\t" + "NumberofComparisons" + "\t" + "BonfCorrEmpiricalPValue" + "\t"+ "EmpiricalPValue" + "\t" + "j/m*delta" + "\t" + "Significant for FDR" + "\n");	
			}
			...
			for(FunctionalElement element : list){
				...
				if(element.getKeggPathwayName()!=null){
					...
					if (Commons.BONFERRONI_CORRECTED_EMPIRICAL_P_VALUE.equals(empiricalPValueType)){	
						bufferedWriter.write(element.getName() + "\t"+ element.getOriginalNumberofOverlaps() + "\t" + element.getNumberofPermutationsHavingOverlapsGreaterThanorEqualto() + "\t" + element.getNumberofPermutations() + "\t" + element.getNumberofComparisons() + "\t" + df.format(element.getBonferroniCorrectedEmpiricalPValue())+ "\t"+ df.format(element.getEmpiricalPValue())+ "\t" + df.format(element.getJoverMtimesDelta()) +"\t" + element.getSignificantFDR() +"\t");	
					} else if(Commons.EMPIRICAL_P_VALUE.equals(empiricalPValueType)){
						bufferedWriter.write(element.getName() + "\t"+ element.getOriginalNumberofOverlaps() + "\t" + element.getNumberofPermutationsHavingOverlapsGreaterThanorEqualto() + "\t" + element.getNumberofPermutations() + "\t" + element.getNumberofComparisons() + "\t" + df.format(element.getEmpiricalPValue()) + "\t" +df.format(element.getBonferroniCorrectedEmpiricalPValue())+ "\t" + df.format(element.getJoverMtimesDelta()) +"\t" + element.getSignificantFDR() +"\t");	
					} else if(Commons.BENJAMINI_HOCHBERG_FDR.equals(empiricalPValueType)){
						bufferedWriter.write(element.getName() + "\t"+ element.getOriginalNumberofOverlaps() + "\t" + element.getNumberofPermutationsHavingOverlapsGreaterThanorEqualto() + "\t" + element.getNumberofPermutations() + "\t" + element.getNumberofComparisons() + "\t" + df.format(element.getBonferroniCorrectedEmpiricalPValue())+ "\t"+ df.format(element.getEmpiricalPValue())+ "\t" + df.format(element.getJoverMtimesDelta()) +"\t" + element.getSignificantFDR() +"\t");	
...
//		String writePermutationBasedAnnotationResultMode = Commons.WRITE_PERMUTATION_BASED_ANNOTATION_RESULT;
		...
		//Calculate Empirical P Values and Bonferroni Corrected Empirical P Values
		//List<FunctionalElement> list is filled in this method
		//Using name2AccumulatedKMap and originalName2KMap
		...
		annotateOneThousandPermutationsUsingForkJoin.writetoFile(dnaseList,Commons.DNASE_CELL_LINE_NAME_EMPIRICAL_P_VALUES,Commons.EMPIRICAL_P_VALUE,NUMBER_OF_REPEATS,NUMBER_OF_PERMUTATIONS,generateRandomDataMode,inputDataFileName);
		annotateOneThousandPermutationsUsingForkJoin.writetoFile(tfbsList,Commons.TFBS_NAME_CELL_LINE_NAME_EMPIRICAL_P_VALUES,Commons.EMPIRICAL_P_VALUE,NUMBER_OF_REPEATS,NUMBER_OF_PERMUTATIONS,generateRandomDataMode,inputDataFileName);
		annotateOneThousandPermutationsUsingForkJoin.writetoFile(histoneList,Commons.HISTONE_NAME_CELL_LINE_NAME_EMPIRICAL_P_VALUES,Commons.EMPIRICAL_P_VALUE,NUMBER_OF_REPEATS,NUMBER_OF_PERMUTATIONS,generateRandomDataMode,inputDataFileName);
		
		annotateOneThousandPermutationsUsingForkJoin.writetoFile(exonBasedKeggPathwayList,Commons.EXON_BASED_KEGG_PATHWAY_EMPIRICAL_P_VALUES,Commons.EMPIRICAL_P_VALUE,NUMBER_OF_REPEATS,NUMBER_OF_PERMUTATIONS,generateRandomDataMode,inputDataFileName);
		annotateOneThousandPermutationsUsingForkJoin.writetoFile(regulationBasedKeggPathwayList,Commons.REGULATION_BASED_KEGG_PATHWAY_EMPIRICAL_P_VALUES,Commons.EMPIRICAL_P_VALUE,NUMBER_OF_REPEATS,NUMBER_OF_PERMUTATIONS,generateRandomDataMode,inputDataFileName);
		annotateOneThousandPermutationsUsingForkJoin.writetoFile(allBasedKeggPathwayList,Commons.ALL_BASED_KEGG_PATHWAY_EMPIRICAL_P_VALUES,Commons.EMPIRICAL_P_VALUE,NUMBER_OF_REPEATS,NUMBER_OF_PERMUTATIONS,generateRandomDataMode,inputDataFileName);
			
		annotateOneThousandPermutationsUsingForkJoin.writetoFile(tfCellLineExonBasedKeggPathwayList,Commons.TF_CELLLINE_EXON_BASED_KEGG_PATHWAY_EMPIRICAL_P_VALUES,Commons.EMPIRICAL_P_VALUE,NUMBER_OF_REPEATS,NUMBER_OF_PERMUTATIONS,generateRandomDataMode,inputDataFileName);
		annotateOneThousandPermutationsUsingForkJoin.writetoFile(tfCellLineRegulationBasedKeggPathwayList,Commons.TF_CELLLINE_REGULATION_BASED_KEGG_PATHWAY_EMPIRICAL_P_VALUES,Commons.EMPIRICAL_P_VALUE,NUMBER_OF_REPEATS,NUMBER_OF_PERMUTATIONS,generateRandomDataMode,inputDataFileName);
		annotateOneThousandPermutationsUsingForkJoin.writetoFile(tfCellLineAllBasedKeggPathwayList,Commons.TF_CELLLINE_ALL_BASED_KEGG_PATHWAY_EMPIRICAL_P_VALUES,Commons.EMPIRICAL_P_VALUE,NUMBER_OF_REPEATS,NUMBER_OF_PERMUTATIONS,generateRandomDataMode,inputDataFileName);
		
		annotateOneThousandPermutationsUsingForkJoin.writetoFile(tfExonBasedKeggPathwayList,Commons.TF_EXON_BASED_KEGG_PATHWAY_EMPIRICAL_P_VALUES,Commons.EMPIRICAL_P_VALUE,NUMBER_OF_REPEATS,NUMBER_OF_PERMUTATIONS,generateRandomDataMode,inputDataFileName);
		annotateOneThousandPermutationsUsingForkJoin.writetoFile(tfRegulationBasedKeggPathwayList,Commons.TF_REGULATION_BASED_KEGG_PATHWAY_EMPIRICAL_P_VALUES,Commons.EMPIRICAL_P_VALUE,NUMBER_OF_REPEATS,NUMBER_OF_PERMUTATIONS,generateRandomDataMode,inputDataFileName);
		annotateOneThousandPermutationsUsingForkJoin.writetoFile(tfAllBasedKeggPathwayList,Commons.TF_ALL_BASED_KEGG_PATHWAY_EMPIRICAL_P_VALUES,Commons.EMPIRICAL_P_VALUE,NUMBER_OF_REPEATS,NUMBER_OF_PERMUTATIONS,generateRandomDataMode,inputDataFileName);

		
		//After sorting w.r.t. empirical p values in ascending order
		//Calculate Benjamini and Hochberg FDR
		BenjaminiandHochberg.controlFalseDiscoveryRate(dnaseList,level);
		BenjaminiandHochberg.controlFalseDiscoveryRate(histoneList,level);
		BenjaminiandHochberg.controlFalseDiscoveryRate(tfbsList,level);
		
		BenjaminiandHochberg.controlFalseDiscoveryRate(exonBasedKeggPathwayList,level);
		BenjaminiandHochberg.controlFalseDiscoveryRate(regulationBasedKeggPathwayList,level);
		BenjaminiandHochberg.controlFalseDiscoveryRate(allBasedKeggPathwayList,level);
		
		BenjaminiandHochberg.controlFalseDiscoveryRate(tfExonBasedKeggPathwayList,level);
		BenjaminiandHochberg.controlFalseDiscoveryRate(tfRegulationBasedKeggPathwayList,level);
		BenjaminiandHochberg.controlFalseDiscoveryRate(tfAllBasedKeggPathwayList,level);
		
		BenjaminiandHochberg.controlFalseDiscoveryRate(tfCellLineExonBasedKeggPathwayList,level);
		BenjaminiandHochberg.controlFalseDiscoveryRate(tfCellLineRegulationBasedKeggPathwayList,level);
		BenjaminiandHochberg.controlFalseDiscoveryRate(tfCellLineAllBasedKeggPathwayList,level);
		
		//sort w.r.t. FDR in descending order
		Collections.sort(dnaseList, FunctionalElement.BENJAMINI_HOCHBERG_FDR);
		Collections.sort(histoneList, FunctionalElement.BENJAMINI_HOCHBERG_FDR);
		Collections.sort(tfbsList, FunctionalElement.BENJAMINI_HOCHBERG_FDR);
		
		Collections.sort(exonBasedKeggPathwayList, FunctionalElement.BENJAMINI_HOCHBERG_FDR);
		Collections.sort(regulationBasedKeggPathwayList, FunctionalElement.BENJAMINI_HOCHBERG_FDR);
		Collections.sort(allBasedKeggPathwayList, FunctionalElement.BENJAMINI_HOCHBERG_FDR);
		
		Collections.sort(tfExonBasedKeggPathwayList, FunctionalElement.BENJAMINI_HOCHBERG_FDR);
		Collections.sort(tfRegulationBasedKeggPathwayList, FunctionalElement.BENJAMINI_HOCHBERG_FDR);
		Collections.sort(tfAllBasedKeggPathwayList, FunctionalElement.BENJAMINI_HOCHBERG_FDR);
		
		Collections.sort(tfCellLineExonBasedKeggPathwayList, FunctionalElement.BENJAMINI_HOCHBERG_FDR);
		Collections.sort(tfCellLineRegulationBasedKeggPathwayList, FunctionalElement.BENJAMINI_HOCHBERG_FDR);
		Collections.sort(tfCellLineAllBasedKeggPathwayList, FunctionalElement.BENJAMINI_HOCHBERG_FDR);
		
		
		//write sorted Significant for FDR to files
		annotateOneThousandPermutationsUsingForkJoin.writetoFile(dnaseList,Commons.DNASE_CELL_LINE_NAME_BENJAMINI_HOCHBERG_FDR + "_Level_" + level, Commons.BENJAMINI_HOCHBERG_FDR,NUMBER_OF_REPEATS,NUMBER_OF_PERMUTATIONS,generateRandomDataMode,inputDataFileName);
		annotateOneThousandPermutationsUsingForkJoin.writetoFile(tfbsList,Commons.TFBS_NAME_CELL_LINE_NAME_BENJAMINI_HOCHBERG_FDR + "_Level_" + level, Commons.BENJAMINI_HOCHBERG_FDR,NUMBER_OF_REPEATS,NUMBER_OF_PERMUTATIONS,generateRandomDataMode,inputDataFileName);
		annotateOneThousandPermutationsUsingForkJoin.writetoFile(histoneList,Commons.HISTONE_NAME_CELL_LINE_NAME_BENJAMINI_HOCHBERG_FDR + "_Level_" + level,Commons.BENJAMINI_HOCHBERG_FDR,NUMBER_OF_REPEATS,NUMBER_OF_PERMUTATIONS,generateRandomDataMode,inputDataFileName);
		
		annotateOneThousandPermutationsUsingForkJoin.writetoFile(exonBasedKeggPathwayList,Commons.EXON_BASED_KEGG_PATHWAY_BENJAMINI_HOCHBERG_FDR + "_Level_" + level,Commons.BENJAMINI_HOCHBERG_FDR,NUMBER_OF_REPEATS,NUMBER_OF_PERMUTATIONS,generateRandomDataMode,inputDataFileName);
		annotateOneThousandPermutationsUsingForkJoin.writetoFile(regulationBasedKeggPathwayList,Commons.REGULATION_BASED_KEGG_PATHWAY_BENJAMINI_HOCHBERG_FDR + "_Level_" + level,Commons.BENJAMINI_HOCHBERG_FDR,NUMBER_OF_REPEATS,NUMBER_OF_PERMUTATIONS,generateRandomDataMode,inputDataFileName);
		annotateOneThousandPermutationsUsingForkJoin.writetoFile(allBasedKeggPathwayList,Commons.ALL_BASED_KEGG_PATHWAY_BENJAMINI_HOCHBERG_FDR + "_Level_" + level,Commons.BENJAMINI_HOCHBERG_FDR,NUMBER_OF_REPEATS,NUMBER_OF_PERMUTATIONS,generateRandomDataMode,inputDataFileName);
				
		annotateOneThousandPermutationsUsingForkJoin.writetoFile(tfExonBasedKeggPathwayList,Commons.TF_EXON_BASED_KEGG_PATHWAY_BENJAMINI_HOCHBERG_FDR + "_Level_" + level,Commons.BENJAMINI_HOCHBERG_FDR,NUMBER_OF_REPEATS,NUMBER_OF_PERMUTATIONS,generateRandomDataMode,inputDataFileName);
		annotateOneThousandPermutationsUsingForkJoin.writetoFile(tfRegulationBasedKeggPathwayList,Commons.TF_REGULATION_BASED_KEGG_PATHWAY_BENJAMINI_HOCHBERG_FDR + "_Level_" + level,Commons.BENJAMINI_HOCHBERG_FDR,NUMBER_OF_REPEATS,NUMBER_OF_PERMUTATIONS,generateRandomDataMode,inputDataFileName);
		annotateOneThousandPermutationsUsingForkJoin.writetoFile(tfAllBasedKeggPathwayList,Commons.TF_ALL_BASED_KEGG_PATHWAY_BENJAMINI_HOCHBERG_FDR + "_Level_" + level,Commons.BENJAMINI_HOCHBERG_FDR,NUMBER_OF_REPEATS,NUMBER_OF_PERMUTATIONS,generateRandomDataMode,inputDataFileName);
		
		annotateOneThousandPermutationsUsingForkJoin.writetoFile(tfCellLineExonBasedKeggPathwayList,Commons.TF_CELLLINE_EXON_BASED_KEGG_PATHWAY_BENJAMINI_HOCHBERG_FDR + "_Level_" + level,Commons.BENJAMINI_HOCHBERG_FDR,NUMBER_OF_REPEATS,NUMBER_OF_PERMUTATIONS,generateRandomDataMode,inputDataFileName);
		annotateOneThousandPermutationsUsingForkJoin.writetoFile(tfCellLineRegulationBasedKeggPathwayList,Commons.TF_CELLLINE_REGULATION_BASED_KEGG_PATHWAY_BENJAMINI_HOCHBERG_FDR + "_Level_" + level,Commons.BENJAMINI_HOCHBERG_FDR,NUMBER_OF_REPEATS,NUMBER_OF_PERMUTATIONS,generateRandomDataMode,inputDataFileName);
		annotateOneThousandPermutationsUsingForkJoin.writetoFile(tfCellLineAllBasedKeggPathwayList,Commons.TF_CELLLINE_ALL_BASED_KEGG_PATHWAY_BENJAMINI_HOCHBERG_FDR + "_Level_" + level,Commons.BENJAMINI_HOCHBERG_FDR,NUMBER_OF_REPEATS,NUMBER_OF_PERMUTATIONS,generateRandomDataMode,inputDataFileName);
...
//		annotateOneThousandPermutationsUsingForkJoin.writetoFileSmallValueInsteadofZero(random,regulationBasedKeggPathwayList,Commons.REGULATION_BASED_KEGG_PATHWAY_EMPIRICAL_P_VALUES,Commons.EMPIRICAL_P_VALUE,NUMBER_OF_REPEATS,NUMBER_OF_PERMUTATIONS,generateRandomDataMode,inputDataFileName);
		...
		annotateOneThousandPermutationsUsingForkJoin.writetoFile(dnaseList,Commons.DNASE_CELL_LINE_NAME_EMPIRICAL_P_VALUES_USING_BONFERRONI_CORRECTION, Commons.BONFERRONI_CORRECTED_EMPIRICAL_P_VALUE,NUMBER_OF_REPEATS,NUMBER_OF_PERMUTATIONS,generateRandomDataMode,inputDataFileName);
		annotateOneThousandPermutationsUsingForkJoin.writetoFile(tfbsList,Commons.TFBS_NAME_CELL_LINE_NAME_EMPIRICAL_P_VALUES_USING_BONFERRONI_CORRECTION,Commons.BONFERRONI_CORRECTED_EMPIRICAL_P_VALUE,NUMBER_OF_REPEATS,NUMBER_OF_PERMUTATIONS,generateRandomDataMode,inputDataFileName);
		annotateOneThousandPermutationsUsingForkJoin.writetoFile(histoneList,Commons.HISTONE_NAME_CELL_LINE_NAME_EMPIRICAL_P_VALUES_USING_BONFERRONI_CORRECTION,Commons.BONFERRONI_CORRECTED_EMPIRICAL_P_VALUE,NUMBER_OF_REPEATS,NUMBER_OF_PERMUTATIONS,generateRandomDataMode,inputDataFileName);
		    
		annotateOneThousandPermutationsUsingForkJoin.writetoFile(exonBasedKeggPathwayList,Commons.EXON_BASED_KEGG_PATHWAY_EMPIRICAL_P_VALUES_USING_BONFERRONI_CORRECTION,Commons.BONFERRONI_CORRECTED_EMPIRICAL_P_VALUE,NUMBER_OF_REPEATS,NUMBER_OF_PERMUTATIONS,generateRandomDataMode,inputDataFileName);
		...
		annotateOneThousandPermutationsUsingForkJoin.writetoFile(allBasedKeggPathwayList,Commons.ALL_BASED_KEGG_PATHWAY_EMPIRICAL_P_VALUES_USING_BONFERRONI_CORRECTION,Commons.BONFERRONI_CORRECTED_EMPIRICAL_P_VALUE,NUMBER_OF_REPEATS,NUMBER_OF_PERMUTATIONS,generateRandomDataMode,inputDataFileName);
		...
		annotateOneThousandPermutationsUsingForkJoin.writetoFile(tfCellLineAllBasedKeggPathwayList,Commons.TF_CELLLINE_ALL_BASED_KEGG_PATHWAY_EMPIRICAL_P_VALUES_USING_BONFERRONI_CORRECTION,Commons.BONFERRONI_CORRECTED_EMPIRICAL_P_VALUE,NUMBER_OF_REPEATS,NUMBER_OF_PERMUTATIONS,generateRandomDataMode,inputDataFileName);

		annotateOneThousandPermutationsUsingForkJoin.writetoFile(tfExonBasedKeggPathwayList,Commons.TF_EXON_BASED_KEGG_PATHWAY_EMPIRICAL_P_VALUES_USING_BONFERRONI_CORRECTION,Commons.BONFERRONI_CORRECTED_EMPIRICAL_P_VALUE,NUMBER_OF_REPEATS,NUMBER_OF_PERMUTATIONS,generateRandomDataMode,inputDataFileName);
		annotateOneThousandPermutationsUsingForkJoin.writetoFile(tfRegulationBasedKeggPathwayList,Commons.TF_REGULATION_BASED_KEGG_PATHWAY_EMPIRICAL_P_VALUES_USING_BONFERRONI_CORRECTION,Commons.BONFERRONI_CORRECTED_EMPIRICAL_P_VALUE,NUMBER_OF_REPEATS,NUMBER_OF_PERMUTATIONS,generateRandomDataMode,inputDataFileName);
		annotateOneThousandPermutationsUsingForkJoin.writetoFile(tfAllBasedKeggPathwayList,Commons.TF_ALL_BASED_KEGG_PATHWAY_EMPIRICAL_P_VALUES_USING_BONFERRONI_CORRECTION,Commons.BONFERRONI_CORRECTED_EMPIRICAL_P_VALUE,NUMBER_OF_REPEATS,NUMBER_OF_PERMUTATIONS,generateRandomDataMode,inputDataFileName);
