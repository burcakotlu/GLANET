...
public class ChromosomeBasedMapabilityArray {
	...
	public static MapabilityFloatArray getChromosomeMapabilityArray(String dataFolder,ChromosomeName chromName, int chromSize){
		switch(chromName){
			case CHROMOSOME1 :  return getChr1Mapability(dataFolder,chromSize); 
			case CHROMOSOME2 :  return getChr2Mapability(dataFolder,chromSize);
			case CHROMOSOME3 :  return getChr3Mapability(dataFolder,chromSize);
			case CHROMOSOME4 :  return getChr4Mapability(dataFolder,chromSize);
			case CHROMOSOME5 :  return getChr5Mapability(dataFolder,chromSize);
			case CHROMOSOME6 :  return getChr6Mapability(dataFolder,chromSize);
			case CHROMOSOME7 :  return getChr7Mapability(dataFolder,chromSize);
			case CHROMOSOME8 :  return getChr8Mapability(dataFolder,chromSize);
			case CHROMOSOME9 :  return getChr9Mapability(dataFolder,chromSize);
			case CHROMOSOME10 : return getChr10Mapability(dataFolder,chromSize);
			case CHROMOSOME11 : return getChr11Mapability(dataFolder,chromSize);
			case CHROMOSOME12 : return getChr12Mapability(dataFolder,chromSize);
			case CHROMOSOME13 : return getChr13Mapability(dataFolder,chromSize);
			case CHROMOSOME14 : return getChr14Mapability(dataFolder,chromSize);
			case CHROMOSOME15 : return getChr15Mapability(dataFolder,chromSize);
			case CHROMOSOME16 : return getChr16Mapability(dataFolder,chromSize);
			case CHROMOSOME17 : return getChr17Mapability(dataFolder,chromSize);
			case CHROMOSOME18 : return getChr18Mapability(dataFolder,chromSize);
			case CHROMOSOME19 : return getChr19Mapability(dataFolder,chromSize);
			case CHROMOSOME20 : return getChr20Mapability(dataFolder,chromSize);
			case CHROMOSOME21 : return getChr21Mapability(dataFolder,chromSize);
			case CHROMOSOME22 : return getChr22Mapability(dataFolder,chromSize);
			case CHROMOSOMEX  : return getChrXMapability(dataFolder,chromSize);
			case CHROMOSOMEY  : return getChrYMapability(dataFolder,chromSize);						
		}
