...
public class Commons {
	...
	// EnumType EnrichmentDecision
	public static final String P_VALUE_CALCULATED_FROM_Z_SCORE = "P_VALUE_CALCULATED_FROM_Z_SCORE";
	public static final String P_VALUE_CALCULATED_FROM_NUMBER_OF_PERMUTATIONS_RATIO = "P_VALUE_CALCULATED_FROM_NUMBER_OF_PERMUTATIONS_RATIO";
	public static final String BOTH_ZSCORE_AND_NUMBEROFPERMUTATIONSRATIO = "BOTH_ZSCORE_AND_NUMBEROFPERMUTATIONSRATIO";
	public static final String OLD_RESULT_FILE_VERSION = "OLD_RESULT_FILE_VERSION";
	...
	public static final String PERFORM_ENRICHMENT_WITH_KEEPING_NUMBER_OF_OVERLAPS_COMING_FROM_EACH_PERMUTATION = "PERFORM_ENRICHMENT_WITH_KEEPING_NUMBER_OF_OVERLAPS_COMING_FROM_EACH_PERMUTATION";
	// Consumes less memory
	public static final String PERFORM_ENRICHMENT_WITHOUT_KEEPING_NUMBER_OF_OVERLAPS_COMING_FROM_EACH_PERMUTATION = "PERFORM_ENRICHMENT_WITHOUT_KEEPING_NUMBER_OF_OVERLAPS_COMING_FROM_EACH_PERMUTATION";
