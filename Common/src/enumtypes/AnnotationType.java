...
public enum AnnotationType {
	...
	DO_DNASE_ANNOTATION( 1), DO_NOT_DNASE_ANNOTATION( 2),

	DO_TF_ANNOTATION( 3), DO_NOT_TF_ANNOTATION( 4),

	DO_HISTONE_ANNOTATION( 5), DO_NOT_HISTONE_ANNOTATION( 6),

	DO_GENE_ANNOTATION( 7), DO_NOT_GENE_ANNOTATION( 8),

	DO_KEGGPATHWAY_ANNOTATION( 9), DO_NOT_KEGGPATHWAY_ANNOTATION( 10),

	DO_TF_KEGGPATHWAY_ANNOTATION( 11), DO_NOT_TF_KEGGPATHWAY_ANNOTATION( 12),

	DO_TF_CELLLINE_KEGGPATHWAY_ANNOTATION( 13), DO_NOT_TF_CELLLINE_KEGGPATHWAY_ANNOTATION( 14),
	...
	DO_USER_DEFINED_GENESET_ANNOTATION( 17), DO_NOT_USER_DEFINED_GENESET_ANNOTATION( 18),

	DO_USER_DEFINED_LIBRARY_ANNOTATION( 19), DO_NOT_USER_DEFINED_LIBRARY_ANNOTATION( 20);
