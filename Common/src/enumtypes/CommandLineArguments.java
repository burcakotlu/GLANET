...
public enum CommandLineArguments {
	...
	PerformEnrichmentWithKeepingNumberofOverlapsComingFromEachPermutation( 6,
			Commons.PERFORM_ENRICHMENT_WITHOUT_KEEPING_NUMBER_OF_OVERLAPS_COMING_FROM_EACH_PERMUTATION), // this
	...
	KeggPathwayAnnotation( 16, Commons.DO_NOT_KEGGPATHWAY_ANNOTATION), TfAndKeggPathwayAnnotation( 17,
			Commons.DO_NOT_TF_KEGGPATHWAY_ANNOTATION), CellLineBasedTfAndKeggPathwayAnnotation( 18,
			Commons.DO_NOT_TF_CELLLINE_KEGGPATHWAY_ANNOTATION), RegulatorySequenceAnalysisUsingRSAT( 19,
			Commons.DO_NOT_REGULATORY_SEQUENCE_ANALYSIS_USING_RSAT), JobName( 20, Commons.NO_NAME),
	WriteElementBasedAnnotationFoundOverlapsMode( 21, Commons.DO_NOT_WRITE_ELEMENT_BASED_ANNOTATION_FOUND_OVERLAPS),
	WriteAnnotationBinaryMatrixMode( 22, Commons.DO_NOT_WRITE_ANNOTATION_BINARY_MATRIX), WriteGeneratedRandomDataMode(
			23, Commons.DO_NOT_WRITE_GENERATED_RANDOM_DATA),
	WritePermutationBasedandParametricBasedAnnotationResultMode( 24,
	...
	UserDefinedGeneSetAnnotation( 27, Commons.DO_NOT_USER_DEFINED_GENESET_ANNOTATION), UserDefinedGeneSetInput( 28,
			Commons.NO_OPTIONAL_USERDEFINEDGENESET_FILE_PROVIDED), UserDefinedGeneSetGeneInformation( 29,
			Commons.GENE_SYMBOL), UserDefinedGeneSetName( 30, Commons.NO_NAME), UserDefinedGeneSetDescriptionFile( 31,
			Commons.NO_OPTIONAL_USERDEFINEDGENESET_DESCRIPTION_FILE_PROVIDED), UserDefinedLibraryAnnotation( 32,
			Commons.DO_NOT_USER_DEFINED_LIBRARY_ANNOTATION), UserDefinedLibraryInput( 33,
			Commons.NO_OPTIONAL_USERDEFINEDLIBRARY_FILE_PROVIDED), UserDefinedLibraryDataFormat( 34,
			Commons.USERDEFINEDLIBRARY_DATAFORMAT_0_BASED_START_ENDEXCLUSIVE_COORDINATES), GivenInputDataType( 35,
			Commons.GIVEN_INPUT_DATA_CONSISTS_OF_SNPS), NumberOfArguments( 36);
