...
public enum CommandLineArguments {
	...
	AssociationMeasureType(4,Commons.NUMBER_OF_OVERLAPPING_BASES),
	NumberOfBasesRequiredForOverlap(5, Commons.NUMBER_BASES_DEFAULT),
	PerformEnrichment(6, Commons.DO_NOT_ENRICH),
	EnrichmentZScoreMode( 7,Commons.PERFORM_ENRICHMENT_WITH_ZSCORE),
	GenerateRandomDataMode( 8, Commons.GENERATE_RANDOM_DATA_WITH_MAPPABILITY_AND_GC_CONTENT),
	MultipleTesting( 9, Commons.BENJAMINI_HOCHBERG_FDR),
	BonferroniCorrectionSignificanceCriteria( 10, Commons.SIGNIFICANCE_CRITERIA_DEFAULT),
	FalseDiscoveryRate( 11, Commons.FDR_DEFAULT),
	NumberOfPermutation( 12, Commons.NUMBER_OF_PERMUTATIONS_DEFAULT),
	DnaseAnnotation( 13, Commons.DO_NOT_DNASE_ANNOTATION),
	HistoneAnnotation( 14, Commons.DO_NOT_HISTONE_ANNOTATION),
	TfAnnotation( 15, Commons.DO_NOT_TF_ANNOTATION),
	GeneAnnotation( 16, Commons.DO_NOT_GENE_ANNOTATION), // and this
	KeggPathwayAnnotation( 17, Commons.DO_NOT_KEGGPATHWAY_ANNOTATION), 
	TfAndKeggPathwayAnnotation( 18,Commons.DO_NOT_TF_KEGGPATHWAY_ANNOTATION), 
	...
	WritePermutationBasedAnnotationResultMode( 26, Commons.DO_NOT_WRITE_PERMUTATION_BASED_ANNOTATION_RESULT),
	NumberOfPermutationsInEachRun( 27, Commons.NUMBER_OF_PERMUTATIONS_IN_EACH_RUN_DEFAULT),
	UserDefinedGeneSetAnnotation( 28, Commons.DO_NOT_USER_DEFINED_GENESET_ANNOTATION), 
	UserDefinedGeneSetInput( 29,Commons.NO_OPTIONAL_USERDEFINEDGENESET_FILE_PROVIDED), 
	UserDefinedGeneSetGeneInformation( 30,Commons.GENE_SYMBOL), 
	UserDefinedGeneSetName( 31, Commons.NO_NAME), 
	UserDefinedGeneSetDescriptionFile( 32,Commons.NO_OPTIONAL_USERDEFINEDGENESET_DESCRIPTION_FILE_PROVIDED), 
