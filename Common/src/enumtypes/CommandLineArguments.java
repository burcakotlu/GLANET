...
public enum CommandLineArguments {
	...
	KeggPathwayAnnotation(14, Commons.DO_NOT_KEGGPATHWAY_ANNOTATION),
	TfAndKeggPathwayAnnotation(15, Commons.DO_NOT_TF_KEGGPATHWAY_ANNOTATION),
	CellLineBasedTfAndKeggPathwayAnnotation(16, Commons.DO_NOT_TF_CELLLINE_KEGGPATHWAY_ANNOTATION),
	RegulatorySequenceAnalysisUsingRSAT(17, Commons.DO_NOT_REGULATORY_SEQUENCE_ANALYSIS_USING_RSAT),
	JobName(18, Commons.NO_NAME),
	WriteElementBasedAnnotationFoundOverlapsMode(19,Commons.DO_NOT_WRITE_ELEMENT_BASED_ANNOTATION_FOUND_OVERLAPS),
	WriteAnnotationBinaryMatrixMode(20,Commons.DO_NOT_WRITE_ANNOTATION_BINARY_MATRIX),
	WriteGeneratedRandomDataMode(21, Commons.DO_NOT_WRITE_GENERATED_RANDOM_DATA),
	WritePermutationBasedandParametricBasedAnnotationResultMode(22, Commons.DO_NOT_WRITE_PERMUTATION_BASED_AND_PARAMETRIC_BASED_ANNOTATION_RESULT),
	WritePermutationBasedAnnotationResultMode(23, Commons.DO_NOT_WRITE_PERMUTATION_BASED_ANNOTATION_RESULT),
	NumberOfPermutationsInEachRun(24, Commons.NUMBER_OF_PERMUTATIONS_IN_EACH_RUN_DEFAULT),
	UserDefinedGeneSetAnnotation(25, Commons.DO_NOT_USER_DEFINED_GENESET_ANNOTATION),
	UserDefinedGeneSetInput(26, Commons.NO_OPTIONAL_USERDEFINEDGENESET_FILE_PROVIDED),
	UserDefinedGeneSetGeneInformation(27, Commons.GENE_SYMBOL),
	UserDefinedGeneSetName(28, Commons.NO_NAME),
	UserDefinedGeneSetDescriptionFile(29, Commons.NO_OPTIONAL_USERDEFINEDGENESET_DESCRIPTION_FILE_PROVIDED),
	UserDefinedLibraryAnnotation(30, Commons.DO_NOT_USER_DEFINED_LIBRARY_ANNOTATION),
	UserDefinedLibraryInput(31, Commons.NO_OPTIONAL_USERDEFINEDLIBRARY_FILE_PROVIDED),
	UserDefinedLibraryDataFormat(32, Commons.USERDEFINEDLIBRARY_DATAFORMAT_0_BASED_START_ENDEXCLUSIVE_COORDINATES),
	GivenInputDataType(33,Commons.GIVEN_INPUT_DATA_CONSISTS_OF_SNPS),
	NumberOfArguments(34);
