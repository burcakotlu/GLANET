...
public enum CommandLineArguments {
	...
	RegulatorySequenceAnalysisUsingRSAT(18, Commons.DO_NOT_REGULATORY_SEQUENCE_ANALYSIS_USING_RSAT),
	JobName(19, Commons.NO_NAME),
	WriteElementBasedAnnotationFoundOverlapsMode(20,Commons.DO_NOT_WRITE_ELEMENT_BASED_ANNOTATION_FOUND_OVERLAPS),
	WriteAnnotationBinaryMatrixMode(21,Commons.DO_NOT_WRITE_ANNOTATION_BINARY_MATRIX),
	WriteGeneratedRandomDataMode(22, Commons.DO_NOT_WRITE_GENERATED_RANDOM_DATA),
	WritePermutationBasedandParametricBasedAnnotationResultMode(23, Commons.DO_NOT_WRITE_PERMUTATION_BASED_AND_PARAMETRIC_BASED_ANNOTATION_RESULT),
	WritePermutationBasedAnnotationResultMode(24, Commons.DO_NOT_WRITE_PERMUTATION_BASED_ANNOTATION_RESULT),
	NumberOfPermutationsInEachRun(25, Commons.NUMBER_OF_PERMUTATIONS_IN_EACH_RUN_DEFAULT),
	UserDefinedGeneSetAnnotation(26, Commons.DO_NOT_USER_DEFINED_GENESET_ANNOTATION),
	UserDefinedGeneSetInput(27, Commons.NO_OPTIONAL_USERDEFINEDGENESET_FILE_PROVIDED),
	UserDefinedGeneSetGeneInformation(28, Commons.GENE_SYMBOL),
	UserDefinedGeneSetName(29, Commons.NO_NAME),
	UserDefinedGeneSetDescriptionFile(30, Commons.NO_OPTIONAL_USERDEFINEDGENESET_DESCRIPTION_FILE_PROVIDED),
	UserDefinedLibraryAnnotation(31, Commons.DO_NOT_USER_DEFINED_LIBRARY_ANNOTATION),
	UserDefinedLibraryInput(32, Commons.NO_OPTIONAL_USERDEFINEDLIBRARY_FILE_PROVIDED),
	UserDefinedLibraryDataFormat(33, Commons.USERDEFINEDLIBRARY_DATAFORMAT_0_BASED_START_ENDEXCLUSIVE_COORDINATES),
	GivenInputDataType(34,Commons.GIVEN_INPUT_DATA_CONSISTS_OF_SNPS),
