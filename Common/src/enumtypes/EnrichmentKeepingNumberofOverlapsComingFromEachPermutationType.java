...
public enum EnrichmentKeepingNumberofOverlapsComingFromEachPermutationType {
    ...
    * class itself.
    */
    private EnrichmentKeepingNumberofOverlapsComingFromEachPermutationType(int enrichmentKeepingNumberofOverlapsDecision) {
    ...
    public static EnrichmentKeepingNumberofOverlapsComingFromEachPermutationType convertStringtoEnum(String enrichmentKeepingNumberofOverlapsDecision){
