...
public enum WritePermutationBasedandParametricBasedAnnotationResultMode {
	...
	private WritePermutationBasedandParametricBasedAnnotationResultMode(
			int writePermutationBasedandParametricBasedAnnotationResultMode) {
	...
	public static WritePermutationBasedandParametricBasedAnnotationResultMode convertStringtoEnum(
