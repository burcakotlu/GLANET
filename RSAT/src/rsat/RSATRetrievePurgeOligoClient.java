...
public class RSATRetrievePurgeOligoClient {
	 ...
	 *	RSAT tools retrieve-seq, purge-sequence and oligo-analys is linked in a workflow.
	...
	*/
		...
		public static void main(String[] args) {
			try
			{
				System.out.println("This demo script illustrates a work flow combining three requests to ...");
...
//				public RSATWS.RSATWSPortType getRSATWSPortType() throws javax.xml.rpc.ServiceException {
				...
				retrieveSeqParams.setNoorf(new Integer(1));
				retrieveSeqParams.setNocom(new Integer(0));
				...
				oligoParams.setNoov(new Integer(1));
				// Search on both strands
				oligoParams.setStr(new Integer(2));
				...
				String[] lth = {"occ_sig 0"};
				oligoParams.setLth(lth);
				/*Call the service*/
