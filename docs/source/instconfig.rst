...
3. Download executable GLANET.jar from :ref:`Executable <download>`
	
4. Download Data.zip from :ref:`Data <download>` and extract it under a directory you name it, for example GLANET (e.g.: ~path/to/GLANET/). 
