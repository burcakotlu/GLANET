...
| Input File Format.      +------------+-------------------+--------------+                      | 
| Select one of them.     | -f0        |  Required         | -c           |                      |
|                         +------------+-------------------+--------------+                      | 
|                         | -fbed      |  Required         | -c           |                      |
|                         +------------+-------------------+--------------+                      |
|                         | -fgff      |  Required         | -c           |                      |
...
| Input File              | -udginfosym|  Required         | -udg         |                      |
| Gene Information Type   +------------+-------------------+--------------+                      |
|                         | -udginforna|  Required         | -udg         |                      |
+-------------------------+------------+-------------------+--------------+----------------------+
...
+-------------------------+------------+-------------------+--------------+                      |
|                         | -udldf0inc |  Required         | -udl         |                      |
+-------------------------+------------+-------------------+--------------+                      |
|                         | -udldf1exc |  Required         | -udl         |                      |
+-------------------------+------------+-------------------+--------------+                      |
|                         | -udldf1inc |  Required         | -udl         |                      |
+-------------------------+------------+-------------------+--------------+----------------------+
